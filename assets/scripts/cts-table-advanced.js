var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
            ...
            var sOut = '<table>';
            sOut += '<tr><td>Subsidiary:</td><td>'+aData[2]+'</td></tr>';
            sOut += '<tr><td>Sub Subsidiary:</td><td>'+aData[3]+'</td></tr>';
            sOut += '<tr><td>Detail:</td><td>'+aData[4]+'</td></tr>';
            sOut += '<tr><td>Sub Detail:</td><td>'+aData[5]+'</td></tr>';
            sOut += '<tr><td>A/C Code:</td><td>'+aData[6]+'</td></tr>';
            sOut += '</table>';
