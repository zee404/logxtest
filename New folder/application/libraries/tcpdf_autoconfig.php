...
if (!defined('PDF_HEADER_LOGO')) {
	//$tcpdf_header_logo = 'leo_logo222.png';
	$tcpdf_header_logo = 'p_logo.png';
	if (@file_exists(K_PATH_IMAGES.'tcpdf_logo.png')) {
		//$tcpdf_header_logo = 'leo_logo123.png';
		$tcpdf_header_logo = 'p_logo.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'http://ltnworld.com');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'http://ltnworld.com');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'LEO COMMUNICATION (PVT) LTD');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "\nhttp://erp.ltnworld.com/");
}
