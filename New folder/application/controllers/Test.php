    ...
    $im_cnt=0;
         foreach (glob($path.'*.{xlsx,xls,png,jpg,jpeg}',GLOB_BRACE) as $file) 
         {
             if (is_file($file)) 
             {
                ...
                // 2021-12-15
                // < '2022-02-03'
                // 2022-01-17 deliv imgs
                // 2022-02-17 deliv img
                // files xls 03-05-2022
                 // files xls 2022-04-01
                // 2022-03-17 deliv imgs
                // 2022-04-08 deliv imgs
                 // 2022-04-29 xls 
                //  2022-05-01 deliv image
                // 2022-05-15 xls
                 //  2022-05-16 deliv image
                  // 2022-06-05 xls
                if (date('Y-m-d',filemtime($file)) < '2022-05-20') 
                {
                  //  OLD //  unlink($fileX);
                 // OLD  $ima[] = $file;
