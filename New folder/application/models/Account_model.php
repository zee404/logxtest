...
class Account_model extends CI_Model{
    ...
    */
    ...
    var $table_transac = "partner_incoming";
   ...
   public function save_vat_($d)
    ...
    {
        $this->db->insert($this->table_transac,$data);
        return $this->db->insert_id();
    }
    
    
     public function get_months_incomings($tb,$where){
       
        //$where['status'] = 0;
       
        $query = $this->db->select('*, DATE_FORMAT(from_dt,"%d-%m-%Y") as 	from_dt, DATE_FORMAT(to_dt,"%d-%m-%Y") as to_dt')->order_by('created_at', 'DESC')->get_where($this->table_transac, $where);
       
       // return $this->db->last_query();
        return $query->result();
       
    }
     public function get_where_detail_is($tb,$where){
       
        //$where['status'] = 0;
       
        $query = $this->db->select('*, DATE_FORMAT(from_dt,"%d-%m-%Y") as 	from_dt, DATE_FORMAT(to_dt,"%d-%m-%Y") as to_dt')->order_by('created_at', 'ASC')->get_where($tb, $where);
       // return $this->db->last_query();
        return $query->result();
