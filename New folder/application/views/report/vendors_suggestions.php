                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Reports </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Partner's Suggestions </a></li>
                                  
                                </ol>
                            </div>
                          <h4 class="page-title">Partner's Suggestions</h4>
                        </div>
                    </div>
                </div>
                </div>
...
<div class="container-fluid">
      ...
      <div class="row ">
                    ...
                    <div class="col-lg-3">
                         ...
                         <select class="form-control" name="op" id="op" required="">
                            ...
                            <option value="Solved">Acknowledged</option>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <tr class="odd gradeX">
            <td ><?php echo $data->fed_id ?> </td>
             <td ><?php echo $data->vendor .'<br/>'.$data->v_phone ?> </td>
            <td ><?php echo $data->email ?> </td>
             <td style="min-width:250px;"><?php echo $data->address ?> </td>
             
              <td style="min-width:250px;"><?php echo $data->feedback ?> </td>
              <td ><?php echo $data->reported_at ?> </td>
            <!--<td  id="fed_status"><?php //echo $data->fed_status ?> </td>-->
            
            <?php if($data->fed_status=='Solved'){
                echo '<td id="fed_status">Acknowledged</td>';
                }else{
                echo '<td id="fed_status">'.$data->fed_status.'</td>';
                }
                ?>
...
<script type="text/javascript">
    ...
    function get_deliveries_report_by_vendor(vendor_id, el){
        ...
        var url = "<?php echo base_url(); ?>"+"report/get_vendor_suggestion_by_";
        $fields = {'start_date':from_date, 'end_date':to_date, 'vendor_id':vendor_id, 'op':op};
          ...
          tbody += '<tr class="odd gradeX">';
            ...
            tbody += '<td style="min-width:250px;" >'+ e.address +'</td>';
             ...
             tbody += '<td style="min-width:250px;">'+ e.feedback +'</td>';
              ...
              if(e.fed_status=='Solved'){
            tbody += '<td> Acknowledged </td>';
              }else{
