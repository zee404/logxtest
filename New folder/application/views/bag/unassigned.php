              ...
              <?php }else { ?>
                <div class="row">
                     ...
                     <div class="col-lg-4" style="display: none;" id="action_btn">
                        ...
                        <button id="print_btn" type="button" class="btn btn-danger" style="margin-bottom:15px;">Print Label</button>
                   </div>
                  </div>
              <?php } ?>
                            ...
                            <table class="example table-responsive table-bordered" style="display: table; overflow-x: auto;" data-toggle="table">
                                ...
                                <tr class="abc">
                                    ...
                                    <th style="min-width: 80px">Type(Emirate With Time)</th>
