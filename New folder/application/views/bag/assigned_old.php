            ...
            <div class="container-fluid">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Operations </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Assigned Bag Collection</a></li>
                                  
                                </ol>
                            </div>
                            <h4 class="page-title">Assigned Bags Collection</h4>
                        </div>
                    </div>
                </div>     
                ...
                <div class="row">
                    <div class="col-sm-12">
                     ...
                     <form action="<?php echo base_url('bag/assigned_by_created_date') ?>" method="post">
                    <div class="row">
                            ...
                            <table  class="example" data-toggle="table">
                                ...
                                <tbody>
                                    ...
                                    foreach ($orders['records'] as $key => $order) { ?>
                                        <tr>
                                              <td><input type="checkbox" class="checkboxes" onclick="add_item(this.value)"  value="<?php echo $order->bag_id;?>" /></td>
