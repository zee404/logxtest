                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Reports</a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Storekeeper Forcefully Deliveries</a></li>
                                  
                                </ol>
                            </div>
                             <h4 class="page-title">Storekeeper Forcefully Deliveries</h4>
                        </div>
                    </div>
                </div>     
                           ...
                           <div class="card-box" style="overflow-x: auto;">  
                            ...
                            <table class="table table-responsive table-bordered" style="display: table; overflow-x: auto;" id="order_table">
                                ...
                                <tr style="height: 50px">
                                    ...
                                    <th style="min-width: 130px">Total Deliveries</th>
