...
.highlights{
background: #1785175c;font-size: larger;
}
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="<?php echo base_url('auth/userdashboard');?>">Dashboard </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Active Drivers</a></li>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="report_table">
                        ...
                        <tbody id="table_body">
                            ...
                            for($key=0; $key<count($records);){
                              $count=$count+1;
                              $cnt=0;
                            //   echo $records[$key]->driver_id;
                            //   die();
                            //   echo $data[$key]->driver_id;
                            //   die();
                              ?>
             ...
             <td ><?php echo $records[$key]->email ?> </td>
               ...
               <td>
                   <table class="table table-bordered">
                       ...
                       <th class="highlights">Total Deliveries</th>
                       <th class="highlights">Total Completed</th>
                       <th class="highlights">Total Pending / Assigned</th>
                       <th class="highlights">Total Canceled</th>
                       <th class="highlights">Total Inshiped</th>
                       
                      
                      
                <?php $xtemp=$key; if($records[$key]->driver_id == $records[$key+1]->driver_id){ //echo 'i am driver id check true key is:'.$key;  ?>
                ...
                // echo 'i am while loop runing temp key is:'.$xtemp;
                   ...
                   $basic_urlx=base_url().'/auth/deliveries_detail_status_Check/'.$s_date.'/'.$e_date.'/d/'.$records[$key]->driver_id.'/slot/'.$slot_time.'/';
                    $basic_urlx_for_comp=base_url().'/auth/get_driver_report_all_/'.$s_date.'/'.$e_date.'/d/'.$records[$key]->driver_id.'/slot/'.$slot_time.'/';
                   
                   
                // echo '<tr><td class="slots_highlight">'.$records[$xtemp]->delivery_time.'</td><td>'.$records[$xtemp]->orders.'</td><td>'.$records[$xtemp]->total_delivered.'</td><td>'.$records[$xtemp]->total_assign.'</td><td>'.$records[$xtemp]->total_canceled.'</td><td>'.$records[$xtemp]->total_ship.'</td></tr>'; 
                echo '<tr><td class="slots_highlight"><a title="Click to view Time-Slot wise" target="_blank" href="'.$basic_urlx.'" >'.$records[$xtemp]->delivery_time.'</a></td><td><a title="Click to view Total Deliveries" target="_blank" href="'.$basic_urlx.'" >'.$records[$xtemp]->orders.'</a></td><td><a title="Click to view Delivered orders" target="_blank" href="'.$basic_urlx_for_comp.'delivered'.'" >'.$records[$xtemp]->total_delivered.'</a></td><td><a title="Click to view Assigned Deliveries" target="_blank" href="'.$basic_urlx.'assigned'.'" >'.$records[$xtemp]->total_assign.'</a></td><td><a title="Click to view Canceled Deliveries" target="_blank" href="'.$basic_urlx.'canceled'.'" >'.$records[$xtemp]->total_canceled.'</a></td><td><a title="Click to view Inshiped Deliveries" target="_blank" href="'.$basic_urlx.'inship'.'" >'.$records[$xtemp]->total_ship.'</a></td></tr>'; 
                     
                    
                    $totDel=$totDel+$records[$xtemp]->orders; 
                    $totComp=$totComp+$records[$xtemp]->total_delivered; 
                    $totPen=$totPen+$records[$xtemp]->total_assign; 
                    $totCan=$totCan+$records[$xtemp]->total_canceled; 
                    $totIn=$totIn+$records[$xtemp]->total_ship;
                    
                    
                    $xtemp=$xtemp+1;
                }while($records[$key]->driver_id == $records[$xtemp]->driver_id); 
                
               }else{
                // echo ' <tr><td class="slots_highlight">'.$records[$xtemp]->delivery_time.'</td><td>'.$records[$xtemp]->orders.'</td><td>'.$records[$xtemp]->total_delivered.'</td><td>'.$records[$xtemp]->total_assign.'</td><td>'.$records[$xtemp]->total_canceled.'</td><td>'.$records[$xtemp]->total_ship.'</td> ';
                   $s_date=$this->uri->segment(3)? $this->uri->segment(3): date('Y-m-d');
                   $e_date=$this->uri->segment(4)? $this->uri->segment(4): date('Y-m-d');
                ...
                echo '<tr><td class="slots_highlight"><a title="Click to view Time-Slot wise" target="_blank" href="'.$basic_urlx.'" >'.$records[$xtemp]->delivery_time.'</a></td><td><a title="Click to view Total Deliveries" target="_blank" href="'.$basic_urlx.'" >'.$records[$xtemp]->orders.'</a></td><td><a title="Click to view Delivered orders" target="_blank" href="'.$basic_urlx.'delivered'.'" >'.$records[$xtemp]->total_delivered.'</a></td><td><a title="Click to view Assigned Deliveries" target="_blank" href="'.$basic_urlx.'assigned'.'" >'.$records[$xtemp]->total_assign.'</a></td><td><a title="Click to view Canceled Deliveries" target="_blank" href="'.$basic_urlx.'canceled'.'" >'.$records[$xtemp]->total_canceled.'</a></td><td><a title="Click to view Inshiped Deliveries" target="_blank" href="'.$basic_urlx.'inship'.'" >'.$records[$xtemp]->total_ship.'</a></td></tr>'; 
              ...
              <tr>
                        ...
                        <?php $basic_urly=base_url().'/auth/deliveries_detail_status_Check/'.$s_date.'/'.$e_date.'/d/'.$records[$key]->driver_id.'/slot/'; ?>
                           ...
                           <td class="highlights"><?php echo $totIn ; ?></td>
...
<script type="text/javascript">
   ...
   var base_url=<?php echo base_url ?> ;
    ...
    function get_reports(e){
        ...
        window.location.href = base_url+'auth/Active_Drivers_new/'+from_date+'/'+to_date;
