                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Operations </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Unassigned DeliveriesX</a></li>
                            ...
                            <table id="order_table"  class="example  table  table-responsive  table-bordered ">
                                ...
                                <tr>
                                    ...
                                    <th data-field="id" data-sortable="true" data-formatter="">Ser#</th>
                                     ...
                                     <th data-field="suggestion" data-sortable="true" data-formatter="">Suggested Driver</th>
                                ...
                                <tbody id="table_body">
                                    ...
                                    foreach ($orders['records'] as $key => $order) { ?>
                                            ...
                                            <?php if($order->new_delivery_check){?>
                                                          <tr class="new_deliv" id="<?php echo $order->order_id;?>">
                                            ...
                                            <td ><input type="checkbox" class="checkboxes" data-val="<?php echo $order->order_id;?>"   data-area_id="<?php echo $order->areaID;?>" data-emi_id="<?php echo $order->emirateID;?>"  data-slot_id="<?php echo $order->slotID;?>" value="<?php echo $order->order_id;?>" data-n="<?php $anytemp=explode(",",$order->delivery_address);$inde= count($anytemp)-1; $anytemp2=explode(",",$order->delivery_type);$inde2= count($anytemp2)-1; echo $anytemp[$inde].','.$anytemp2[$inde2]; ?>" style="zoom: 2.5;" /></td>
                                            <td><?php echo $key+1;?></td>
                                            
                                            
                                               <td><?php echo $order->suggested_driver_name;?><br> <?php echo $order->suggested_driver_phone;?> </td>
                                            ...
                                            $urlencodedtext="Dear Client,%0a%0aGood Day!%0a%0aWe have a meal plan delivery for you from ".strtoupper($order->vendor)." but unfortunately there is a slight delay in your area because of a unforeseen event, We are trying our best to reach you at the earliest, Sincere apologies for the inconvenience.%0a%0aMany Thanks for your patience and understanding.%0a%0aRegards,TEAM LOGX";
                                           
                                           
                                           ?>
                                            <td><a title="Click here to start whatsApp chat" target="_blank" href="https://wa.me/<?php echo $order->c_phone; ?>/?text=<?php echo $urlencodedtext; ?>"  data-placement="left"><?php echo $order->c_phone.'<br/>';  echo $order->customer;  ?> </a></td>
                                        ...
                                        <td> <?php echo $order->c_phone.'<br/>';  echo $order->customer;  ?></td>
                                           ...
                                           <td><?php echo $order->send_notification ?></td>
                                            ...
                                            <td id="cucc2"><div id="truncateLongTexts"><?php echo $order->company_note; ?></div></td>
                                          ...
                                          <?php if(strtolower($this->session->userdata('role')) != 'vendor'){ ?>  
                                          <td> <a class="" title="Edit" data-toggle="modal" onclick="javascript:order_detail(this)" href="#myModal" pk="<?php echo $order->order_id ?>"><i class="mdi mdi-square-edit-outline" style="font-size: x-large;"></i></a></td>
                                          <?php } ?>  
...
<script type="text/javascript">
     ...
     function init_table(){
        ...
        //  console.log('i am inside init_table above return check');
        //  console.log('i am length:');
        //  console.log($('.example tbody tr').length);
        if($('.example tbody tr').length <= 1)
            return;
            
            //  console.log('i am inside init_table after return check');
            // $('.example'). 
