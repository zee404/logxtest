                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Operations </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Assigned Pickup Bags</a></li>
                                  
                                </ol>
                            </div>
                           <h4 class="page-title">Assigned Pickup Bags</h4>
                        </div>
                    </div>
                </div>     
                          ...
                          <div class="btn-group">
                            ...
                            <div class="card-box" style="width: 104% !important;">  
                              ...
                              <div class="row" style="margin-top: -15px;margin-bottom: 10px; display: none;"id="action_btn">
                                 ...
                                 <div class="col-lg-6" >
                                    <button type="button" onclick="unassign_dels(this)"  class="btn btn_set">Unassign Pickup Bags</button>
                            ...
                            <table id="order_table"   class="example  table  table-responsive  table-bordered ">
                                ...
                                <tr>
                                    ...
                                    <th data-align="left" data-sortable="true" class="timeSlot" style="min-width:100px">Time Slot</th>
                                     <th data-align="left" data-field="left" data-sortable="true" data-formatter="dateFormatter">Driver</th>
                                    
                                    <th data-align="center" data-field="left" data-sortable="true" data-formatter="dateFormatter">Customer</th>
                                    ...
                                    <th data-field="status" data-align="left"  data-sortable="true" data-formatter="">Notes</th>
                                      ...
                                      <tr class="" id="<?php echo $order->order_id;?>">
                                       <td ><input type="checkbox" class="checkboxes" value="<?php echo $order->order_id;?>" data-val="<?php echo $order->order_id;?>"   style="zoom: 2.5;" /></td>
                                        <td><?php echo $key+1;?></td>
                                         ...
                                         <td  style="font-size: initial;color: #0ec5e0;font-weight: 600;"><?php echo $order->driver;?></td>
...
//     }
    ...
    function get_deliveries_report_by_status(el){
       ...
       $("#table_body").empty();
        ...
        var url = "<?php echo base_url(); ?>"+"report/get_Assigned_bagpicks";
