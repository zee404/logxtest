        ...
        <div class="wrapper">
            <div class="container-fluid">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Operations </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Unassigned Pickup Bags <small>Partner Wise</small></a></li>
              ...
              <?php $sx=$this->uri->segment(3)? $this->uri->segment(3): date('Y-m-d');
                       $ex=$this->uri->segment(4)? $this->uri->segment(4): date('Y-m-d', strtotime($sx. ' + 1 days'))
                                                     ?>
                    ...
                    <div class="col-lg-2">
                          <div class="btn-group">
                            ...
                            <table id="order_table"   class="example  table table-responsive   table-bordered ">
                                ...
                                <tr>
                                     <th class="table-checkbox" style="min-width:100px"><input type="checkbox" class="checkAll" style="zoom: 2.5;"></th>

                                    <th data-field="id" data-sortable="true" data-formatter="" style="min-width:100px">Ser#</th>
                                    
                                     <th data-field="d" data-align="center" data-sortable="true" data-formatter="" style="min-width:300px">Partner</th>
                                     <th data-field="d" data-align="center" data-sortable="true" data-formatter="" style="min-width:200px">Total Bags</th>
                                ...
                                <tbody id="table_body">
                                    ...
                                    foreach ($orders['records'] as $key => $order) { ?>
                                      ...
                                      <tr class="" id="<?php echo $order->vendor_id;?>">
                                       <td ><input type="checkbox" class="checkboxes" value="<?php echo $order->vendor_id;?>" data-val="<?php echo $order->vendor_id;?>"   style="zoom: 2.5;" /></td>
                                        <td><?php echo $key+1;?></td>
                                        
                                         
                                        
                                         <td style="font-size: initial;color: #2ab1c9;font-weight: 600;"><?php echo $order->vendor;?><br><?php echo $order->v_phone;?></td>
                                         
                                          <td style="font-size: initial;color: #2ab1c9;font-weight: 600;"><a title="Click here to view detail" target="_blank" href="<?php echo base_url('order/unassigned_bagpicks/').$sx.'/'.$ex.'/'.$order->vendor_id; ?>"><?php echo $order->total_deliveries;?></td></a>
...
function assign_deliv(ids)
{
     ...
     $.ajax({
            ...
            method:'post',
            data:{'vendor_ids':ids,driver_id:driver_id,'from_date':from_date,'to_date':to_date,'emirate_id':emirate_id,'time_id':time_id},
  ...
  function set_report_data(data){
      var from_datei = moment($("#from_date").val()).format('YYYY-MM-DD');
        ...
        $.each(data, function(i, e){
            ...
            tbody += '<td><input type="checkbox" class="checkboxes" value="'+ e.vendor_id+'" style="zoom: 2.5;"  /></td>';
            tbody += '<td >'+ ky +'</td>';
           
             tbody += '<td style="font-size: initial;color: #2ab1c9;font-weight: 600;">'+ e.vendor +'<br>'+e.v_phone+'</td>';
              tbody += '<td style="font-size: initial;color: #2ab1c9;font-weight: 600;"><a title="Click here to view detail" target="_blank" href="'+url+'order/unassigned_bagpicks/'+from_datei+'/'+to_datei+'/'+e.vendor_id+'/'+emirate_id+'/'+time_id+'">'+ e.total_deliveries +'</a></td>';
