        ...
        <div class="wrapper">
          ...
          <!--   <?php echo validation_errors();?>
                ...
                <?php } ?> -->
                            ...
                            <h4 class="page-title">Store Keepers List</h4>
                        </div>
                    </div>
                </div>     
                    ...
                    <div class="modal-content" style="width: 120% !important;">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                               <form id="add_vendor_form" action="<?php echo base_url('vendor/save_storekeeper') ?>" method="post" class="horizontal-form" >
    ...
    function gen_password()
{
    ...
    function get_vendor_by_id(id){
        ...
        var url = "<?php echo base_url(); ?>"+"vendor/get_storekeeper_by_id";
        $fields = {'vendor_id':id};
    ...
    function update_vendor(){
        ...
        var url = "<?php echo base_url(); ?>"+"vendor/update_storekeeper";

        if(email && vendor_id){
            $fields = {'name':name, 'email': email, 'address':address,'old_email':oldEmail, 'vendor_id':vendor_id, 'phone':phone,'Password_partner':Password_partner};
            $.post(url, $fields, function(response){
                if(response.success){
            ...
            var error = '<strong>Error!</strong> try latter! issue found.';
