                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Reports</a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Completed Delayed Deliveries</a></li>
                                  
                                </ol>
                            </div>
                             <h4 class="page-title">Completed Delayed Deliveries</h4>
                        </div>
                    </div>
                </div>     
                           ...
                           <div class="card-box" style="overflow-x: auto;">  
                            ...
                            <table class="table table-responsive table-bordered" style="display: table; overflow-x: auto;" id="order_table">
                                ...
                                <tr style="height: 50px">
                                    ...
                                    <th style="min-width: 110px">Delivered time</th>
                                    <th style="min-width: 110px">Delay Time</th>
    ...
    jQuery(document).ready(function() {
         ...
         $("#from_date").flatpickr({
            ...
            onChange: function(sd, ds, ins){
                $("#to_date").flatpickr({
                    defaultDate: moment(ds).add(1,'days').format('YYYY-MM-DD'),
                    minDate: ds,
                    maxDate:moment(ds).add(+35,'days').format('YYYY-MM-DD'),
                });
            }
...
var Difference_In_Days = Difference_In_Time / (1000 * 3600 * 24);
        ...
        "ajax": {
            "url": "<?php echo base_url('report/get_deliveries_report_by_completed_latedelivs') ?>",
            "type": "POST",
        ...
        "columns": [
            ...
            { "data": "delivered_date_time" , "orderable": true},
            { "data": "diff_is", "orderable": true},
            { "data": "delivered_date" , "orderable": true},
             { "data": "driver" },
            { "data": "vendor" },
        ...
        dom: 'Blifrtip',
            ...
            swal.fire('','Only last 5 week results can be displayed. ','warning')
        }
    }
