                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                          ...
                          <h4 class="page-title">Upload Deliveries via File OR via Form</h4>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    echo form_open_multipart('order/upload_deliveries_by_general_file_new'); ?>
                                    <div class="row">
                                    ...
                                    <?php } ?>
                                        ...
                                        <div class="col-md-3" style="margin-bottom: 20px;">
                                            ...
                                            <button type="button" class="btn btn-primary" id="uploadBtn" style="color: #fff;background-color: #197990 !important;">Select File</button><span id="file_namee"></span>
                                        </div>
                                        <div class="col-md-2">
...
<!--tabindex="-1"-->
    <div id="delvModal" class="modal fade"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <form method="post" action="<?php echo base_url('order/save_order_form') ?>" class="order_form_save">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="search_option form-control" name="order_area" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="search_option form-control" id="field-44" name="order_shift" required>
                            ...
                            <div id="custom-modals" class="modal-demo" style="padding: 35px;">
                                 ...
                                 <blockquote class="hero">
                                        ...
                                        <p> Click <a href="<?php echo base_url('ptests/excel') ?>">HERE</a> to Download Deliveries XLSX File Format!</p>
                                    </blockquote>
