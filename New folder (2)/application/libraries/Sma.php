 ...
 *  ==============================================================================
 *  Author    : Mian Saleem
 *  Email     : saleem@cyanbs.com
 *  For       : Cyan Business Solution
 *  Web       : http://www.cyanbs.com
 *  ==============================================================================
 */
...
class Sma
{
    ...
    public function send_email($to, $subject, $message, $from = null, $from_name = null, $attachment = null, $cc = null, $bcc = null)
    {
        ...
        if ($domain != 'tecdiary.com') {
            ...
            $config['useragent'] = "Cyan Business Solution";
    ...
    public function qrcode($type = 'text', $text = null, $size = 4, $level = 'H', $sq = null,$order = null)
    {
       $file_name = 'qr_codes/' . $order . ($sq ? $sq : '') . '.png';
