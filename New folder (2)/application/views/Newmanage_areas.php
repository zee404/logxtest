                    ...
                    <div class="modal-content" style="width: 380px;">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form id="add_area_form" action="#" method="post" class="horizontal-form" >
                                    <input type="hidden" name="area_id" value="" id="area_id" class="form-control">
                        ...
                        <div class="modal-footer">
                            <button id="save_area_btn" type="button" onclick="save_area()" class="btn green"style="background: black;color: white;">Save</button>
...
<!--shan-->
        ...
        <script type="text/javascript">
           ...
           $(document).ready(function () {
            ...
            }else if(document.location.href.indexOf("del=notAllowed") != -1){
            ...
            $(".del_area").click(function(e){
                ...
                swal({
                    title: "Are you sure? This will also effect driver schedule!",
    ...
    //SAVE vendor METHODS
     ...
     function save_area(){
       hide_error();
        ...
        area_name.trim();
// console.log(area_name);   //prints: 123
        var emirate_name=$("#emirate option:selected").html();
        var emirate_id=$("#emirate option:selected").val();
        var tst='('+area_name+')';
        console.log('tst'+tst);
        tst=tst.trim();
        emirate_name=emirate_name.trim();
        var final_name=emirate_name+tst;
        ...
        var url = "<?php echo base_url(); ?>"+"order/Newsave_area";
       
        
                            
        if(area_name && emirate_id){
            $fields = {'area_name':final_name, 'emirate_id':emirate_id ,'area_id':area_id};
            $.post(url, $fields, function(response){
                if(response.success){
                    
                    var msg = '<strong>Success!</strong> Area has saved.';
