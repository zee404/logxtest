                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="<?php echo base_url('auth/userdashboard');?>">Dashboard </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Revenue Details</a></li>
                                  
                                </ol>
                            </div>
                          <h4 class="page-title">Revenue Details</h4>
                        </div>
                    </div>
                </div>
                </div>
        ...
        <div class="col-md-12">
               ...
               <div class="card-box" style="overflow: auto;"> 
                    ...
                    <table class="table table-striped table-bordered table-hover" id="report_table">
                        ...
                        <tr>
                            ...
                            <th>Total Delivered Deliveries</th>
            ...
            <td ><?php echo $data->full_name.'<br/>'.$data->phone ?> </td>
             <td ><?php echo $data->email ?> </td>
              ...
              <td><?php echo $data->total_reveneu ?> </td>
              <td><?php echo $data->total_delivered ?> </td>
              <td><?php echo $data->total_delivered_delivries ?> </td>
               <td><?php echo $data->total_assign ?> </td>
                <td ><?php echo $data->total_not_assign ?> </td>
            <td ><?php echo $data->total_canceled ?> </td>
            <td ><?php echo $data->total_ship ?> </td>
