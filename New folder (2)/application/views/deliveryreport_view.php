                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="<?php echo base_url('auth/userdashboard');?>">Dashboard </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Total Deliveries</a></li>
                                  
                                </ol>
                            </div>
                          <h4 class="page-title">Total Deliveries</h4>
                        </div>
                    </div>
                </div>     
                                ...
                                <form class="form-inline">
                                    <div class="form-group">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input disabled type="text" class="form-control shadow border-white" name="date" id="from_date" value="<?php echo $this->uri->segment(3)? $this->uri->segment(3): date('Y-m-d') ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input disabled type="text" class="form-control shadow border-white" name="date" id="to_date" value="<?php echo $this->uri->segment(4)?$this->uri->segment(4) : date('Y-m-d') ?>">
                                        ...
                                        <?php if($order->discount_track != '0' AND  $order->discount_track != ''){  ?>
                                         ...
                                         <?php  }else{  ?>
                                           ...
                                           <?php    }     ?>
                                            ...
                                            <td><span class="bld"><?php echo $order->delivery_time;?></span></td>
                                            <td><span class="bld"><?php echo $order->v_phone.'<br/>'.$order->vendor;?></span></td>
                                            ...
                                            <?php if($order->status == 'Ship'){ ?>
                                                <td> <span class="bld" style="color:yellow;"> In Progress</span></td>
                                            <?php }else if($order->status =='Assign'){
                                                 echo '<td><span class="bld" style="color:#40e2ac;">Assigned</span></td>';
                                            }else if($order->status =='Not Assign'){
                                                 echo '<td><span class="bld" style="color:beige;">Not Assigned</span></td>';
                                            }else if( $order->status == 'Cancel'){
                                                echo '<td><span class="bld" style="color:#da1b1b;">Canceled</span></td>';
                                            }else{ ?>
                                            <td><span class="bld" style="color:#2cad2c;"><?php echo $order->status ?></span></td>
                                            <?php } ?>
                                            
                                            <td><span class="bld"><?php echo $order->d_phone.'<br/>'.$order->driver;?></span></td>
                                            
                                            <td><span class="bld"><?php echo $order->delivery_date?></span></td>
