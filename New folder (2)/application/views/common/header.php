                    ...
                    <div id="navigation">
                        ...
                        <?php }?>
                         <?php if (in_array('setting',$modules) OR $user_data['role'] == 'admin' AND strtolower($this->session->userdata('role')) != 'vendor') { ?>
                            ...
                            <?php if (in_array('vendors_reports',$modules) OR $user_data['role'] == 'admin') { ?>
                                <li class="has-submenu active">
                                <a href="#"> <i class="fe-trending-up"></i>Vendors Reports<div class="arrow-down"></div></a>
                                <ul class="submenu">
                                    <!-- <li>
                                        <ul> -->
                                            <?php if((strtolower($this->session->userdata('role')) == 'admin' OR in_array('vendors_reports',$modules)) AND strtolower($this->session->userdata('role')) != 'vendor'){ ?>
                                            <li>
                                                <a href="<?php echo base_url('vendor_deliveries_complete_report'); ?>">Vendors Wise Complete Report</a>
                                            </li>
