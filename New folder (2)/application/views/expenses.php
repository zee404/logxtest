                    ...
                    <div class="col-lg-6">
                        ...
                        &nbsp &nbsp
                              <a href="#responsive" onclick="javascript:show_model(this)" flag="add" data-toggle="modal">
                                <button class="btn blue" style="color: #fff;background-color: #197990 !important;border-color: white;">Add New Expense </button>
                            </a>
                            &nbsp &nbsp
                                ...
                                <tr>
                                  <th class="table-checkbox"><input type="checkbox" class="group-checkable checkAll" ></th>
                                    ...
                                    <th style="min-width: 200px" data-field="name" data-sortable="true">Title</th>
                                     <th data-field="" data-align="center" data-sortable="true" data-formatter="">Amount</th>
                                    ...
                                    <th data-field="l" data-align="center" data-sortable="true" data-formatter="">Prof Image</th>
                                ...
                                $count=0; foreach ($d['records'] as $key => $data) {?>
                                        <tr>
                                            ...
                                            <!--Prof image-->
                                             ...
                                             <td ><?php if($data->prof_img!=''){ ?>
                                             <a class="big-link green" data-animation="fade" data-reveal-id="Carpet" href="<?php echo base_url($data->prof_img) ?>" target="_blank">Available</a>
                                            <?php }else{ ?>
                ...
                <div class="modal-dialog" style="width: 500px">
                    <div class="modal-content" style="width: 120% !important;">
                        <div class="modal-header" style="background: linear-gradient(to right, #004C5D 0%, #00BAF1 100%);">
                            ...
                            <h4 class="modal-title" id="mod_title" style="color: white;">Add New Expense</h4>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form name="form" id="add_vendor_form" action="<?php echo base_url('Driveryy/save_driver') ?>" method="post" class="horizontal-form" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <span id="amount_check_msg" style="color: red"></span>
                                              ...
                                              <div class="row">
                                               <div class="col-md-6">
                                                    <div class="form-group ">
                                                        <label class="control-label">Prof Image</label>
...
function delAll()
{
    ...
    $.ajax({
            url:'<?php echo base_url("Driver/del_remove_expense") ?>',
            method:'post',
            data:{ids: tmp.join()},
 ...
 $(document).on('change', '.checkAll', function(){
  ...
  $(this).closest('tr').toggleClass('yellow', $(this).is(':checked'));
        ...
        window.location.href = base_url+'driver/expense_list/'+from_date+'/'+to_date;
...
<script type="text/javascript">
 ...
 function show_model(ele){
     ...
     //  $('.del_when_open_new').remove();
        ...
        if(flag == 'add'){
            //changed model title
            $("#mod_title").html('Add New Expense');
    ...
    function get_by_id(id){
        ...
        var url = "<?php echo base_url(); ?>"+"Driver/get_expense_by_id";
        $fields = {'id':id};
        $.post(url, $fields, function(response){
         ...
         $("#description").val(resp.description);
           ...
           $("#vendor_id").val(resp.id);
                ...
                console.log(resp.prof_img);
                if(resp.prof_img !=''){
                    
                    
                     $("#license_span").html('<br><a class="big-link green" data-animation="fade" data-reveal-id="Carpet" href="'+resp.prof_img+'" target="_blank">Available</a>');
                       $('#s_license_image').attr('src', resp.prof_img);
                }else{
    ...
    function update_vendor(){
        ...
        if (amount == '' || amount==0 || amount<0){
            var error = '<strong>Error!</strong> Please Enter Valid Expense';
            show_msg(error, 'alert-danger');
            return false;
        }
    ...
    var valid_check=1;
       ...
       var formData = new FormData($('form')[1]);
        ...
        $.ajax({
            ...
            url: "<?php echo base_url(); ?>"+"Driver/update_expense",
            data:formData,
            processData: false,
            contentType: false,
    ...
    function save_vendor(){
     ...
     console.log('hallo');
        ...
        var url = "<?php echo base_url(); ?>"+"Driver/save_expense";
        ...
        if( name && amount && date){
            $fields = {'name':name, 'amount': amount, 'description':description, 'date':date ,'license':license };
            $.post(url, $fields, function(response){
                ...
                if(response.success){
                    ...
                    // show_msg(msg, 'alert-success');
                    swal.fire("Expense has been Added Successfully.", "", "success");
                    location.reload();
                }else{
