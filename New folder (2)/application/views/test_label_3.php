...
<section>
    <div class="container">
            ...
            <div class="col-md-5 "  style=" border: 3px solid;border-radius: 28px; margin-right: 20px; margin-bottom: 10px;  flex: 0 0 31.666667%; max-width: 31.666667%; /*min-height:480px;*/ ">
            ...
            <!--height: 60px;    margin-top: 11px;    margin-bottom: 2px;    margin-left: 4.5rem;border-radius: 8px;    border: 1px solid #ddd;    padding: 5px;    width: 150px;-->
               <?php if($order['partner_logo'] !=""){?>
                <div style="height: 50px;    margin-top: 4px;    margin-bottom: 1px;    margin-left: 6.5rem;border-radius: 8px;  width: 100px; "><img src="<?php echo base_url().$order['partner_logo']?>"  style="height:100%; width:100%; padding-top: 8px;"   alt=""></div>
               <?php }else{?>
                <div style="height: 50px;    margin-top: 4px;    margin-bottom: 1px;    margin-left: 6.5rem;border-radius: 8px;  width: 100px; "><img src="<?php echo base_url('assets/images/logos-logo-full.png')?>"  style="height:100%; width:100%; padding-top: 8px;"   alt=""></div>
