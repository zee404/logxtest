                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Reports </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Driver Wise Deliveries </a></li>
                                  
                                </ol>
                            </div>
                           <h4 class="page-title">Driver Wise Deliveries</h4>
                        </div>
                    </div>
                </div>
                </div>
      ...
      <div class="row ">
         <!--  <ul class="page-breadcrumb breadcrumb">
                <li class="btn-group" id="download_btn_container" style="display: none">
                    <?php echo form_open('report/csv_driver_deliveries_report', array('id'=>'driver_deliveries','method'=>'post')); ?>
                    ...
                    <input type="hidden" value="<?= date('Y-m-d')?>" name="csv_driver_id" id="csv_driver_id">
                    <button onclick="javascript:submit_form('driver_deliveries')" type="submit_" class="btn green"style=" color: #fff;background-color: #197990 !important;border-color: white;">Download <i class="icon-download"></i></button>
                    <?php echo form_close(); ?>
                </li>
                  <h2 class="page-title" style="margin-top: -18px;">Driver Wise Deliveries</h2>
            </ul> -->
                    <div class="col-sm-12">
                     ...
                     <div class="col-lg-3">
                         ...
                         <select id="driver_list" class="form-control" name="driver_list" required="">
                    ...
                    <div class="col-lg-2">
                          <div class="btn-group">
                            <button onclick="get_deliveries_report_by_driver(event)" class="btn blue"style="color: #fff;background-color: #197990 !important;border-color: white;margin-top: 10px;">Get Report <i class="icon-plus"></i></button>
                            </div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                 ...
                 <div class="card-box" style="overflow: auto;">
                    <table class="table table-striped table-bordered table-hover" id="d_report_table">
...
<!-- END CONTENT -->
 ...
 <!--shan-->
    ...
    //GENERAL METHODS
    function init_table(){
        d_table = $('#d_report_table').dataTable( {
                    dom: 'Blifrtip',
                    buttons: [
    ...
    function get_deliveries_report_by_driver(e){
        console.log('tabkkk');
        $("#download_btn_container").hide();
        var driver_id = $("select#driver_list option:selected").val();
        var from_date = moment($("#from_date").val()).format('YYYY-MM-DD 00:00:00');
        var to_date = moment($("#to_date").val()).format('YYYY-MM-DD 23:59:59');
        var url = "<?php echo base_url(); ?>"+"report/get_deliveries_report_by_driver";

        if(d_table){
            $('#d_report_table').dataTable().fnDestroy();
        }
        ...
        if(driver_id) {
            ...
            $fields = {'start_date': from_date, 'end_date': to_date, 'driver_id': driver_id};
