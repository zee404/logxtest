        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                         <div class="page-title-box">
                            ...
                            <h4 class="page-title">Payment Type</h4>
                        </div>
                    </div>
                </div>     
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                         <div class="page-title-box">
                            ...
                            <h4 class="page-title" style="margin-top: -36px;">Manage your Payments</h4>
              ...
              <table class="example" data-toggle="table" >
                                ...
                                <tbody>
                                        <?php if(!empty($payment)){ foreach ($payment as $key => $data) {?>
                                        <tr>
                                        ...
                                        <td ><?php echo $data->payment_name;?></td>
                                            ...
                                            <td> 
                                                 <a style="color: #0090b8" title="Edit" data-toggle="modal" onclick="javascript:show_model(this)" href="#responsive" flag="edit" pk="<?php echo $data->id?>">
                                                    <i class="mdi mdi-square-edit-outline"></i>
                                                </a>

                                                <a style="color: #0090b8" title="Delete" class="del_type" href="javascript:void(0)" data-id="<?php echo $data->id ?>"><i class="mdi mdi-delete"></i></a>
                ...
                <div class="modal-dialog" style="width: 300px">
                    <div class="modal-content" style="width: 380px;">
                        <div class="modal-header"style="background: linear-gradient(to right, #004C5D 0%, #00BAF1 100%);">
                            ...
                            <h4 class="modal-title" id="mod_title" style="color: white;">Add Payment Type</h4>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form id="add_emirate_form" action="#" method="post" class="horizontal-form" >
                                    <input type="hidden" name="payment_id" value="" id="payment_id" class="form-control">
            ...
            $(".del_type").click(function(e){
                ...
                swal({
                    ...
                    function(isConfirm){
                        ...
                        window.location = "<?php echo base_url('settings/delete_payment') ?>/"+aid;
                        } else {
...
<script type="text/javascript">
 ...
 function show_model(ele){
        ...
        if(flag == 'add'){
            //changed model title
            $("#mod_title").html('Add Payment Type');
            //change model button
        ...
        if(flag == 'edit'){
            //changed model title
            $("#mod_title").html('Edit Payment Type');
            //change model button
            $("#edit_emirate_btn").show();
            $("#save_emirate_btn").hide();
            var payment_id = $(ele).attr('pk');
            console.log('i am payment id:'+payment_id);
            get_emirate_by_id(payment_id);
    ...
    function get_emirate_by_id(id){
        hide_error();
        var url = "<?php echo base_url(); ?>"+"settings/get_paymentType_by_id";
        $fields = {'payment_id':id};
        $.post(url, $fields, function(response){
            if(response.success){
                
                var payment = response.detail[0];
                console.log('i am pay:'+payment);
                $("#name").val(payment.payment_name);
    ...
    function update_emirate(){
        ...
        var url = "<?php echo base_url(); ?>"+"settings/update_paymentType";
        console.log("NAME:"+name + "ID:"+payment_id);
        if(name && payment_id){
            $fields = {'name':name, 'payment_id':payment_id};
            $.post(url, $fields, function(response){
                if(response.success){
                    var msg = '<strong>Success!</strong> Payment type Updated.';
            ...
            var error = '<strong>Error!</strong> Payment type not given.';
    ...
    function save_emirate(){
        ...
        var name = $("#name").val();
        var url = "<?php echo base_url(); ?>"+"settings/save_payment_type";

        if(name){
            $fields = {'payment_name':name};
            $.post(url, $fields, function(response){
                if(response.success){
                    var msg = '<strong>Success!</strong> Payment type has saved.';
                    show_msg(msg, 'alert-success');
                    location.reload();
                }else{
                    show_msg('<strong>Error!</strong> Not Saved try latter.', 'alert-danger');
