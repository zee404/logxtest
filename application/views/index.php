...
<head>
    ...
    <style>
        /* CUSTOM COLOR FOR DELIVERY CHART SLICE */
...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Dashboard</h4> <a href="<?php echo base_url('auth/test'); ?>"> test api</a>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <?php if (strtolower($this->session->userdata('role')) != 'vendor') { ?>
                ...
                <div class="row col-xl-12 collapse show" id="delivery_charts">
                    ...
                    <!-- <div class="card-body ">
                      ...
                      <div class="text-center">
                                    <p class="text-muted font-15 font-family-secondary mb-0">
                                        <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-white"></i> Total</span>
                                        <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-success"></i> Delivered</span>
                                        <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-danger"></i> Pending</span>
                                    </p>
                                </div>
                                <div id="morris-deliveries-chart"  class="morris-chart" data-colors="#4a81d4,#e3eaef,#4fc6e1"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted mb-1 text-truncate"><a href="<?php echo base_url('unassigned') ?>"> Unas. Bags</a></p>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo  $bags[0]['bags_counts']; ?></span></h3>
                                        <p class="text-muted mb-1 text-truncate"><a href="<?php echo base_url('completed'); ?>">Picked Bags</a></p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div> <!-- end widget-rounded-circle-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted mb-1 text-truncate"><a href="<?php echo base_url('total_bags') ?>">Total Bags</a></p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div> <!-- end widget-rounded-circle-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted mb-1 text-truncate"> <a href="<?php echo base_url('vehicle/vehicle_drivers'); ?>" > Total Vehicles</a> </p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div> <!-- end widget-rounded-circle-->
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="widget-rounded-circle card-box">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            <h3 class="text-dark mt-1"><span>&#x62f;&#x2e;&#x625;</span> <span data-plugin="counterup"><?php $deliv_revi = empty($revenue[0]->total_reveneu) ? 0 : round($revenue[0]->total_reveneu, 4);
                                                                                                                                                $bags_revi = empty($revenue_bag[0]->total_reveneu_bag) ? 0 : round($revenue_bag[0]->total_reveneu_bag, 4);
                                                                                                                                                echo round($deliv_revi + $bags_revi, 4) ?></span></h3>
                                ...
                                <?php if (strtolower($this->session->userdata('role')) == 'admin' or strtolower($this->session->userdata('role')) == 'accounts manager') { ?>
                                    ...
                                    <h2 class="text_color"><span>&#x62f;&#x2e;&#x625;</span>
                                        <?php //echo empty($revenue[0]->total_reveneu) ? 0 : $revenue[0]->total_reveneu ; 
                                                ?>
                                        <?php $deliv_revi = empty($revenue[0]->total_reveneu) ? 0 : round($revenue[0]->total_reveneu, 4);
                                                $bags_revi = empty($revenue_bag[0]->total_reveneu_bag) ? 0 : round($revenue_bag[0]->total_reveneu_bag, 4);
                                                echo round($deliv_revi + $bags_revi, 4) ?>
                                    </h2>
                                <?php } ?>
        ...
        <div class="slimscroll-menu rightbar-content">
            ...
            <div class="p-3">
                <div class="inbox-widget">
                    ...
                    <div>
                        <div class='row'>
                            <i class='col mdi mdi-checkbox-blank-circle text-danger'></i>
                            <span class='col text-white p-1 mt-1'>pending: ${element.pending_deliveries}</span>
                        </div>
                    </div>
    ...
    <?php } else if ($this->session->userdata('role_id') == 1) { ?>
        ...
        <!--<script src="<?php //echo base_url('assets/chat/js/csrChat.js') 
                                ?>"></script>-->
    <?php } ?>
    ...
    <script src="<?php echo base_url('assets/libs/chartist/chartist-plugin-tooltip.min.js'); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            init_pie_chart();
            init_deliveries_chart();
            // init_moriss_bar_chart();
          


        });

        function init_deliveries_chart() {
            ...
            $.ajax({
                url: '<?php echo base_url() ?>dashboard/get_deliveries_chart',
                type: 'post',
                data: {
                ...
                success: function(res) {
                    ...
                    try {
                        ...
                        console.log(res[0].delivered_deliveries);
                        console.log(res[0].pending_deliveries);


                        for (let index = 0; index < res.length; index++) {
                            const element = res[index];
                            data = {
                                series: [element.pending_deliveries, element.delivered_deliveries]
                            };

                            
                            var div_id = `deliv-chart${index}`;
                            var div = `deliv-div${index}`;
                            $("#delivery_charts").append(`<div class='col-xl-2 mb-2' id='${div}'> </div>`);
                            $("<div>", {
                            ...
                            new Chartist.Pie(`#${div_id}`, data, {
                                labelInterpolationFnc: function(value, index) {
                                    // return value;
                                }
                            });
                            $(`#${div}`).append(`<div class='text-center align-bottom' > <span class='lead'> ${element.slot}</span><br><a href='<?php echo base_url('auth/Active_total_deliveries/')?>${from_date}/${to_date}/0/${element.slot_id}'> <i class='mdi mdi-checkbox-blank-circle text-primary'></i><span class='text-white p-1 mt-1'>Total: ${element.total_deliveries}</span></a> <br><a href='<?php echo base_url('Order/pending_orders/')?>${from_date}/${to_date}/${element.slot_id}'> <i class='mdi mdi-checkbox-blank-circle text-danger'></i><span class='text-white p-1 mt-1'>pending: ${element.pending_deliveries}</span></a><br><a href='<?php echo base_url('Order/orderCompleted/');?>${from_date}/${from_date}/${element.slot_id}'> <i class='mdi mdi-checkbox-blank-circle text-success'></i><span class='text-white p-1 mt-1'>Completed: ${element.delivered_deliveries}</span></a></div>`);

                        }


                    } catch {
                        console.log('err in initing deliveries pie');
                    }
...
// 
        ...
        //                         data: [{
        //                             label: element.label,
        //                             value: element.pending_deliveries,
        //                             labelColor: 'red',
        //                             slot: 'Pending',
        //                             pending: element.pending_deliveries,
        //                             completed: element.delivered_deliveries,

        //                         }, {
        //                             label: element.label,
        //                             value: element.delivered_deliveries,
        //                             labelColor: 'green',
        //                             slot: 'completed',
        //                             pending: element.pending_deliveries,
        //                             completed: element.delivered_deliveries,
        ...
        //                 //         $('.morris-hover-row-label').text(donut.data[i].delivered_deliveries);
        //                 //         $('.morris-hover-point').text(donut.data[i].pending_deliveries);
        //                 //     });


        //             } catch {
        //                 console.log('err in initing donut chart');
        //             }
        ...
        function init_moriss_bar_chart() {
            $.ajax({
                url: '<?php echo base_url() ?>dashboard/get_deliveries_chart',
                type: 'post',
                data: {
                ...
                success: function(res) {
                    ...
                    try {
                        ...
                        var config = {
                            data: data,
                            xkey: 'label',
                            ykeys: ['value', 'delivered_deliveries', 'pending_deliveries'],
                            labels: ['total', 'Delivered', 'pending'],
                            barColors: ['white', '#1ABC9C', '#F1556C'],
                            hideHover: 'auto',
                            behaveLikeLine: true,
                            resize: true,
                            pointFillColors: ['#ffffff', '#ffff34'],
                            pointStrokeColors: ['white'],
                            lineColors: ['gray', 'red']
                        }
                        config.element = 'morris-deliveries-chart';
                        config.stacked = true;
                        Morris.Bar(config);

                    } catch {
                        console.log('err in initing stacked chart');
                    }
        ...
        function map_data_over_comp_chart(o, b, d) {
            ...
            d.forEach((day, di) => {
                ...
                bag_array.push(bf ? [di, Number(bf.bag_counts)] : [di, 0]); of = o.find(order => order.c_date == day);
