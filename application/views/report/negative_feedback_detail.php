                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Reports </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Customer's -ve Feedback Detail </a></li>
                                  
                                </ol>
                            </div>
                          <h4 class="page-title">Customer's -ve Feedback Detail </h4>
                        </div>
                    </div>
                </div>
                </div>
      ...
      <div class="row ">
                    ...
                    <div class="col-lg-3">
                         ...
                         <select class="form-control" name="op" id="op" required="">
                            ...
                            <option value="ALL">Pending & Acknowledged</option>
...
<script type="text/javascript">
    ...
    function get_deliveries_report_by_vendor(vendor_id, el){
        ...
        var url = "<?php echo base_url(); ?>"+"report/get_deliveries_negative_details_by_";
