                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Reports </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Customer's Positive Feedback </a></li>
                                  
                                </ol>
                            </div>
                          <h4 class="page-title">Customer's Positive Feedback </h4>
                        </div>
                    </div>
                </div>
                </div>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <td ><?php echo $data->name_on_delivery.'<br/>'.$data->c_phone ?> </td>
             <td style="min-width:250px;"><?php echo $data->delivery_address ?> </td>
