                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Reports </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Partner Wise Deliveries </a></li>
                                  
                                </ol>
                            </div>
                          <h4 class="page-title">Partner Wise Deliveries</h4>
                        </div>
                    </div>
                </div>
                </div>
    ...
    <!-- BEGIN PAGE HEADER-->
      <div class="row ">
                    ...
                    <div class="col-sm-11 col-md-11 col-xl-11">
                     ...
                     <div class="col-lg-4">
                           <div class="input-group input-large  input-daterange" data-date="<?php echo $this->uri->segment(3)? $this->uri->segment(3): date('Y-m-d', strtotime(date('Y-m-d') . ' + 1 days')); ?>" data-date-format="dd-mm-yyyy">
                                <input type="text" class="form-control" name="from" id="from_date" value="<?php echo $this->uri->segment(3)? $this->uri->segment(3): date('Y-m-d', strtotime(date('Y-m-d') . ' + 1 days')); ?>">
                                <span class="" style="margin-top: 5px;">&nbsp;&nbsp;To&nbsp;&nbsp;</span>
                                <input type="text" class="form-control" name="to" id="to_date" value="<?php echo $this->uri->segment(3)? $this->uri->segment(3): date('Y-m-d', strtotime(date('Y-m-d') . ' + 1 days')); ?>">
                            </div>
                    </div>
                    <div class="col-lg-2">
                          <div class="btn-group">
    ...
    function set_report_data(data){
        ...
        $.each(data, function(i, e){
          tbody += '<tr class="odd gradeX">';
            ...
            tbody += '<td >'+ e.customer_basic_name +'<br/>'+ e.c_phone +'</td>';
