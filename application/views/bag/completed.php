            ...
            <div class="container-fluid">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Operations </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Completed Bag Collection</a></li>
                                  
                                </ol>
                            </div>
                            <h4 class="page-title">Completed Bag Collection </h4>
                        </div>
                    </div>
                </div>     
                ...
                <div class="row">
                    <div class="col-sm-12">
                     ...
                     <form action="<?php echo base_url('bag/completed_by_created_date') ?>" method="post">
                    <div class="row">
 ...
 -->
                           ...
                           <div class="card-box" style="width: 104% !important; ">  
                            ...
                            <table class="example table table-responsive table-bordered"  style="display: table; overflow-x: auto;"  data-toggle="table">
                                ...
                                <th style="min-width: 100px">Bag Picked at</th>
                                <th>Created</th>
                                <th>Assign Date</th>
                                <th>Need To Be Picked Date</th>
                                <th>Received Bag Qty</th>
                                <th>Received Ice Packs</th>
                                ...
                                <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                           <!--  <td><input type="checkbox" class="checkboxes" value="<?php echo $order->bag_id;?>" /></td> -->
                                            ...
                                            <td ><?php echo $order->type;?></td>
                                             ...
                                             <td ><span class="bold_info"><?php echo $order->bag_picked_at ?></span></td>
                                            ...
                                            <td ><?php echo $order->received_ice_qty;?></td>
                                    ...
                                    <td><?php echo $order->assigned_mode; ?></td>
                                      <td><?php if($order->empty_bag_code!=''){echo $order->empty_bag_code; }else{ echo "None"; } ?></td>
                                    <td> <button class='btn <?php echo ($order->payment_status ==0) ? 'whn_zero' :'bold_with_grn' ?>' onclick='javascript:change_payment_status(this)' value='<?php echo $order->payment_status ?>' data-bag_id='<?php echo  $order->bag_id ?>'><?php echo ($order->payment_status ==0) ? 'Unpaid' :'Paid' ?> </button> </td>
...
<!--shan-->
    ...
    function change_payment_status(status) {
        ...
        $.ajax({
            url: '<?php echo base_url("bag/change_payment_status") ?>',
            method: 'post',
            dataType: 'JSON',
            data: {
                status: status.value,
                bagid: status.dataset.bag_id
            },
