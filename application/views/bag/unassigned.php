...
<head>
    ...
    <link href="<?php echo base_url()?>assets/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet"
        type="text/css" />
...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Unassigned Bag Collection</a>
                                </li>
                   ...
                   $cdate = date('Y-m-d');
                    ?>
                                    ...
                                    <div class="input-group input-large date-picker input-daterange"
                                        data-date="<?php if(!empty($selection["from"])){ echo $selection["from"]; }else{ echo date('Y-m-d'); } ?>">
                                        <input type="text" class="form-control" name="from" id="from_date"
                                            value="<?php if(!empty($selection["from"])){ echo $selection["from"]; }else{ echo date('Y-m-d'); } ?>">
                                        <span class="input-group-addon"
                                            style="margin-top: 6px;">&nbsp;&nbsp;To&nbsp;&nbsp;</span>
                                        <input type="text" class="form-control" name="to" id="to_date"
                                            value="<?php if(!empty($selection["to"])){ echo $selection["to"]; }else{ echo date('Y-m-d', strtotime($cdate. ' + 1 days')); } ?>">
                                    </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="btn-group">
                                        ...
                                        <button class="btn blue" type="submit"
                                            style="color: #fff;background-color: #197990 !important;border-color: white; margin-top: 10px;">Get
                                            Records <i class="icon-plus"></i></button>
            ...
            <div class="card-box" style="width: 104% !important;margin-left: 10px;">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <select id="driver_list" class="search_option form-control" name="driver_list">
                    ...
                    <div class="col-lg-4" style="display: none;" id="action_btn">
                        <button type="button" id="button"
                            style="color: #fff;background-color: #197990 !important;border-color: white;"
                            class="btn btn-primary">Assign</button>
                        <button type="button" id="Auto_button"
                            style="color: #fff;background-color: #197990 !important;border-color: white;"
                            class="btn btn-primary">Auto Assign</button>
                        <button id="delete_button" type="button" class="btn btn-danger">Delete</button>
                        <button id="cancel_button" type="button" class="btn btn-danger">Cancel</button>
                        <button id="print_btn" type="button" class="btn btn-danger">Print Label</button>
                    </div>
                </div>
                <?php }else { ?>
                <div class="row">
                    ...
                    <div class="col-lg-4" style="display: none;" id="action_btn">
                        ...
                        <button id="print_btn" type="button" class="btn btn-danger" style="margin-bottom:15px;">Print
                            Label</button>
                    </div>
                </div>
                <?php } ?>
                ...
                <table class="example table-responsive table-bordered" style="display: table; overflow-x: auto;"
                    data-toggle="table" id="bag_table" >

                    <thead class="thead-light">

                        <tr class="abc">
                            <th class="table-checkbox"><input type="checkbox" class="group-checkable checkAll"
                                    name="checkbox"></th>
                            <th>SR No</th>
                            <th>Customer Name</th>
                            <th>Phone</th>
                            <th data-field="d" data-align="center" data-sortable="true" data-formatter="">Partner</th>
                            <th data-field="t" data-align="center" data-sortable="true" data-formatter="" style="min-width: 80px">Type(Emirate With Time)</th>
                    ...
                    <tbody>
                        ...
                        <tr id="<?php echo $bag->bag_id;?>">
                            <!--  <td><input type="checkbox" class="checkboxes" onclick="add_item(this.value)"  value="<?php echo $bag->bag_id;?>" /></td> -->
                            <td><input type="checkbox" class="checkboxes" data-val="<?php echo $bag->bag_id;?>"
                                    value="<?php echo $bag->bag_id;?>" /></td>
        ...
        <div class="modal-dialog" style="width: 500px">
            <div class="modal-content" style="width: 120% !important;">
                <div class="modal-header" style="background: linear-gradient(to right, #004C5D 0%, #00BAF1 100%);">
                    <button type="button" onclick="close_model()" class="close" data-dismiss="modal"
                ...
                <div class="modal-body">
                    ...
                    <div id="error_container" class="alert " style="display: none">
                        <button class="close" aria-hidden="true" data-dismiss="alert_" onclick="hide_msg(this)"
                            type="button"></button>
                        <p id="error_msg"></p>
                    </div>
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form id="add_vendor_form" action="<?php echo base_url('vendor/save_vendor') ?>" method="post"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required="required" name="modules"
                                            id="modules_partner">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group input-group-sm">
                                        ...
                                        <input type="text" name="phone" placeholder="971-123456789" id="phone"
                                            class="form-control">
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    <button id="save_vendor_btn" type="submit" style="background: black;color: white;"
                        class="btn green">Save</button>
                    <button id="edit_vendor_btn" style="display: none" onclick="update_vendor()" type="button"
                        class="btn green updatebtn" style="background: black;color: white;">Update</button>
                    <button id="responsive" style="background: black;color: white;" onclick="close_model()"
                        type="button" data-dismiss="modal" class="btn default">Close</button>
    ...
    <div id="custom-modals" class="modal-demo" style="padding: 35px;">
        <blockquote class="hero">
            <p> Click <a href="<?php echo base_url(); ?>download/BagCSVFormat.csv">HERE</a> to Download final Bag
                Collection CSV File Format!</p>
        </blockquote>
    ...
    <script src="<?php echo base_url()?>assets/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js" type="text/javascript">
    </script>
    ...
    function auto_assign_deliv() {

        if (global_bags_ids.length > 0) {
            console.log("Called" + global_bags_ids);
            $.ajax({

                url: '<?php echo base_url("bag/Auto_assign_drivers") ?>',
                method: 'post',
                data: {
                    'bag_ids': global_bags_ids
                },
                success: function(res) {
                    ...
                    if (res == 'true') {
                        ...
                        swal("", "Some Bags Not Assigned Successfully!", "error");
                        console.log('not assigned deliviries..............' + res);
