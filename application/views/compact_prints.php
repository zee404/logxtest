...
<section>
    <div class="container" style="">
            ...
            <?php if($count % 2 !=0 OR $count == 1){?>
                      <div class="row pt-1 page-braek"  style="display:flex; column-gap: 35px; ">
                          
                <?php $x=1; } ?>
     
            <div class="col-md-5 "  style=" border: 3px solid;border-radius: 28px;  margin-top: 60px; margin-bottom: 35px; flex: 0 0 48.0%; max-width: 48.0%;  ">
               <!-- style=" border: 3px solid;border-radius: 28px;  margin-bottom: 85px; flex: 0 0 48.0%; max-width: 48.0%; min-height:0px; " -->
            
                <img src="<?php echo base_url('assets/images/logos-logo-full.png')?>"  style="/*height: 35 px; margin-top: 40px; margin-bottom: 25px; margin-left: 7.5rem; */ height: 27px;margin-top: 27px; margin-bottom: 10px;  margin-left: 7.5rem;" alt="">
                ...
                <div class="row" style="padding-left: 10px;padding-right: 10px; ">
                    ...
                    <div class="col-md-3" style="border-top: 3px solid;">
                      <div> 
                       ...
                       <img class="tst" id="<?php echo $order['order_id']; ?>" src="" style="height: 80px;  padding-top: 2px;padding-bottom: 2px;" alt="">
