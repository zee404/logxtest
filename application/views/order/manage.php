                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="input-group input-large date-picker input-daterange" data-date="<?= date('Y-m-d'); ?>">
                                                ...
                                                <input type="text" id="slot_id" value="<?=$this->uri->segment(5) ?$this->uri->segment(5) :0 ?>" hidden>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    foreach ($orders['records'] as $key => $order) { ?>
                                        <tr>
                                            ...
                                            <?php if (strtolower($this->session->userdata('role')) != 'vendor') { ?>
                                                ...
                                                <td><a title="Click here to start whatsApp chat" target="_blank" href="https://wa.me/<?php echo $order->number_on_delivery; ?>/?text=<?php echo $urlencodedtext; ?>" data-placement="left"><?php echo $order->number_on_delivery . '<br/>';
                                                                                                                                                                                                                                                        if ($order->customer == "No Name") {
                                                                                                                                                                                                                                                            echo $order->name_on_delivery;
                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                            echo $order->name_on_delivery;
                                                                                                                                                                                                                                                        } ?></a></td>

                                            <?php } else { ?>
                                                <td> <?php echo $order->number_on_delivery . '<br/>';
                                                                    if ($order->customer == "No Name") {
                                                                        echo $order->name_on_delivery;
                                                                    } else {
                                                                        echo $order->name_on_delivery;
                                            ...
                                            <?php
                                                    ...
                                                    ?>
                                            <td id="cucc2">
                                                <div id="truncateLongTexts"><?php echo  $gad; ?></div>
                                            </td>
            ...
            if (ids.length > 0) {
                $.ajax({
                    ...
                    success: function(resp) {
                        ...
                        rmsg = JSON.parse(resp);
                        if (rmsg.success)
                            swal.fire("Deliveries Manual Completed Successfully", "", "success").then(function() {
                                location.reload();
                            });
                    },
                    error: function(err) {
