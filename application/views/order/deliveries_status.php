                    ...
                    ?>
                     ...
                     <div class="col-lg-3">
                         ...
                         <select class="form-control" name="search_option" id="search_option">
                            ...
                            <option value="Not Assign">Only Unassigned</option>
                            <option value="Assign">Only Assigned</option>
                            <option value="Delivered">Only Completed</option>
                            <option value="Ship">In Progress</option>
                                         ...
                                         <?php  }else{  ?>
                                           ...
                                           <?php    }     ?>
                                            ...
                                            <td>
                                                 ...
                                                 <a class="" title="View" data-toggle="modal" onclick="javascript:order_detail(this)" href="#responsive" pk="<?php echo $order->order_id;?>" tk="<?php echo $order->discount_track;?>">
                                                    <i class="dripicons-preview" style="font-size: 20px;"></i>
                                                </a>
                                                 &nbsp;
                                            <?php if($order->status != 'Delivered'){?>
                                                <?php if(strtolower($this->session->userdata('role')) == 'admin'){  ?>
                                                 <a class="Delete"  data-toggle="modal" onclick="javascript:cancel_delivery(this)" href="#responsive_neww" pk="<?php echo $order->order_id;?>">
...
<script type="text/javascript">
    ...
    function get_deliveries_report_by_status(el){
        ...
        var url = "<?php echo base_url(); ?>"+"report/AC_get_deliveries_report_by_status";
    ...
    function set_report_data(data){
        ...
        $.each(data, function(i, e){
           ...
           if(e.cooling_bag_check == 0){
               tbody += '<td>Paper bag</td>';
              }else if(e.cooling_bag_check == 1){
                 tbody += '<td>Cooler bag</td>';
                   }else{
                   tbody += '<td>Unknown</td>';
                      }
            ...
            tbody += '<td>';
            tbody += '<a class="btn default btn-xs green-stripe" data-toggle="modal" onclick="javascript:order_detail(this)" href="#responsive" pk="'+ e.order_id +'" tk="'+ e.discount_track +'" > <i class="dripicons-preview" style="font-size: 20px;color: #7e57c2;"></i></a>&nbsp;';
            if(e.status != 'Delivered') {
                if (login_user == 'admin') {
                    tbody += '<a title="Cancel" data-toggle="modal" onclick="javascript:cancel_delivery(this)" href="#responsive_neww" pk="' + e.order_id + '"  >';
