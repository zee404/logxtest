...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box" style="height: 70px !important;">
                        <div class="row">
                            <div class="col-lg-2">
                                <a href="#custom-modals" class="btn btn-danger waves-effect waves-light"
                                    data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a"
                                    style="margin-top: -19px;">Status Details</a>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <form action="<?php echo base_url("order/change_brand_code"); ?>"
                                        id="change_brand_code_form" name="change_brand_code_form" method="post">
                                        <div class="input-group input-sm ">
                                            <label style="margin-top: -11px;">Enter brand code:</label>
                                            &nbsp;&nbsp;&nbsp;
                                            <div class="form-group">
                                                <input type="text" maxlength="4" minlength="4" class="form-control" id="brand_code"
                                                    name="brand_code" required / style="margin-top: -17px"
                                                    value="<?php echo $this->session->userdata()['brand_code'] ?>" <?php  if ($this->session->userdata()['brand_code'] != ''){
                                                    echo 'disabled';
                                                } ?>>
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <div>
                                            <button class="btn btn-danger create-btn" type="submit" id="brand_code_btn"
                                                style="margin-top: -18px; <?php  if ($this->session->userdata()['brand_code'] != ''){
                                                    echo 'display: none;';
                                                } ?>">Create code</button>
                                                </div>
                                        </div>
                                ...
                                <div class="col <?php  if ($this->session->userdata()['brand_code'] == ''){
                                                    echo 'd-none';
                                                } ?>">
                                    <form action="<?php echo base_url("order/createqr"); ?>" method="post">
                                        <div class="input-group input-small ">
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <input type="text" maxlength="3" class="form-control" id="quantity"
                                                name="quantity" required / style="margin-top: -17px">
                                            &nbsp;&nbsp;&nbsp;
                                            <button class="btn btn-danger create-btn" type="submit"
                                                style="margin-top: -18px; ">Create New</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <div class="col" style="display: none;" id="action_btn">
                                <button
                                    style="margin-top: -20px;color: #fff;background-color: #197990 !important;border-color: white;"
                                    class="btn btn-secondary buttons-csv buttons-html5 button" tabindex="0" id="button"
                                    aria-controls="demo-custom-toolbar" type="button"><span>Delete</span></button>
                    ...
                    <div class="card-box">
                        ...
                        <div class="row_col_box" style="display: none;">
                            ...
                            <select class="form-control" id="row_col"
                                style="width: 56%;float: right;margin-right: 11px;">
                        ...
                        <table class="example able table-responsive" data-toggle="table">
                            ...
                            <thead class="thead-light">
                                ...
                                <tr>
                                    ...
                                    <th data-field="date" data-sortable="true" data-formatter="dateFormatter">QR Images
                                    </th>
                                    <th data-field="amount" data-align="center" data-sortable="true"
                                        data-sorter="priceSorter">Created at</th>
                                    <th data-field="status" data-align="center" data-sortable="true">Status</th>
                                    <th data-field="cur" data-align="center" data-sortable="true" data-formatter="">
                                        Current Customer</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="checkbox" class="checkboxes" value="<?php echo $bags->qrid;?>"
                                            id="" name="checkbox"></td>
                                    ...
                                    <td><?php if($bags->qrImage!=''){ ?>
                                        <a class="big-link green" data-animation="fade" data-reveal-id="Carpet"
                                            href="<?php echo base_url($bags->qrImage) ?>" target="_blank">Available</a>
                                        <?php }else{ ?>
    ...
    $(document).ready(function() {
        ...
        $("#print_qr").click(function() {
            ...
            if (favorite.length > 0) {
                ...
                window.open(
                    "<?php echo base_url('Order/print_qr/') ?>" + favorite.join(",") + "/" +
                    row_col,
    ...
    $("#change_brand_code_form").submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() ?>order/change_brand_code",
            data: formData,
            dataType: "json",
            encode: true,
            success: function(response) {
                if (response.success) {
                    ...
                    $("#brand_code_error").text(response.error)
