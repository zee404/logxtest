                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="<?php echo base_url('auth/userdashboard');?>">Dashboard </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Total Deliveries With Payment</a></li>
                                  
                                </ol>
                            </div>
                          <h4 class="page-title">Total Deliveries With Payment</h4>
                        </div>
                    </div>
                </div>     
                                        ...
                                        <?php if($order->discount_track != '0' AND  $order->discount_track != ''){  ?>
                                         ...
                                         <?php  }else{  ?>
                                           ...
                                           <?php    }     ?>
                                            ...
                                            <td style="color:red;"><?php echo round($order->delivery_amount,4); ?></td>
                                            <td><?php echo round($order->driver_recvd_amount,4); ?></td>
                                            <td><?php echo round($order->other_payment_driver_recv,4); ?></td>
...
<script type="text/javascript">
    ...
    function get_reports(e){
       e.target.innerHTML = '<span class="spinner-border spinner-border-sm mr-1" role="status" aria-hidden="true"></span> Loading';
        ...
        window.location.href = base_url+'auth/Active_total_deliveries_with_payment/'+from_date+'/'+to_date;
    }
