                         ...
                         <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <?php if ($this->uri->segment(5) == 'edit_delivery_date') { ?>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Manage Plan / Schedule </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Plan Delivery Date/ Schedule </a></li>
                           ...
                           <!--   <?php echo validation_errors();?>
                            ...
                            <h4 class="page-title"> 
                             <?php if (!empty($this->uri->segment(5))) { ?>
                                    <?php if ($this->uri->segment(5) == 'edit_delivery_date') { ?>
                                    Edit Plan Delivery Date/ Schedule
                                    <?php }}?>
                ...
                <div class="row">
                        ...
                        <div class="card-box">
                            ...
                            <form  onsubmit="return validateMyForm();" action="<?php echo base_url('MonthlyMeal/save_order_del') ?>" id="add_vendor_form"  name ="form" method="post" class="horizontal-form" enctype="multipart/form-data">
                               ...
                               <input type="hidden" name="Expiry_date" value="0" id="Expiry_date" class="form-control">
                                ...
                                <!--Manage Plans-->
                                <h2>Edit Delivery Date / Reschedule Deliveries</h2>
                                <br>
                            ...
                            <div  class="row" style="margin-top: 30px;">
                             ...
                             <!--START FOR SKIP DAYS RESCHEDULE-->
                             
                              <div class="col-sm-4">
                                        <div class="form-group">
                                            <div id="output"></div>
                                            <label class="control-label">Select Skip Weekdays <small>(Optional)</small></label>
                       ...
                       <div class="col-md-5">
                            <div class="form-group">
                                <div class="col-md-10">
                                     ...
                                     <label>Select Start Date to Reschedule </label>
                                    <div class="input-group input-large date-picker input-daterange" data-date="<?= date('Y-m-d', strtotime($cdate. ' + 1 days')); ?>" >
                                      ...
                                      <span class="input-group-addon" style="margin-top: 6px;">From&nbsp;&nbsp;</span>
                                       ...
                                       <input type="text" class="form-control flatpickr-input active" name="from" id="from_date" value="<?php  echo date('Y-m-d', strtotime($cdate. ' + 1 days')); ?>" required>
                                        ...
                                        <button type="button" id="generate_days" class="btn btn-info">Schedule</button>
                    ...
                    <div class="col-md-2 " >
                            ...
                            <div class="" style="margin-top:5px;">
                                      ...
                                      <input type="text" class="form-control" value=""  id="no_of_days" name="no_of_days" readonly/>
                              ...
                              <div id="sch_plan" style="display:none">
                                ...
                                <h2>Select date to manage schedule</h2>
...
<script type="text/javascript">
var num_day_record=0;
var day_added_counter=0;
var XP_secure='';
var new_freezed_row_cntr=parseInt(0);
var old_bag_rows_counter_copy=parseInt(0);
var previous_day_rec=0;
var planID_secure=0;
var this_date_is='';
 var valid_check=0;
 var to_count_total_num_rows=0;
...
<script type="text/javascript">
var status = false;
 var active_delivery_counter_for_schedule=0;
 contract ='';
...
$("#generate_days").on('click', function () {
    ...
    //  alert('Generate days are runing : The number of days are:'+$("#num_of_rows").val());

   
    
    
    
 var assumed_upcoming_delivery_dates = []; 
//  alert($("#num_of_rows").val());
//  die();
   ...
   var fix_from=$("#from_date").val();
    ...
    //  HALO
       ...
       var date=fro;
        ...
        if(active_delivery_counter_for_schedule !=0){
            var entered_plan_days=parseInt(active_delivery_counter_for_schedule,10) - parseInt(1);
            // alert('active_delivery_counter_for_schedule: '+entered_plan_days);
       }else{
             alert('No days are available to generate');
            //  die();
        }
...
var final_date_Calculated= yyyy + "-" + (mm[1]?mm:"0"+mm[0]) + "-" + (dd[1]?dd:"0"+dd[0]); // padding
    ...
    //   alert('final_date_Calculated_X'+final_date_Calculated_X);
...
//  alert(dayx);
 ...
 if($("#module").val().includes(dayx)){
                    ...
                    //   alert('after incr assumed days are:'+assumed_days);
         ...
         if(skip && check){
                 ...
                 day_i +=1;
                   ...
                   day_i +=1;
                    ...
                    // console.log('--------------AYESHA HERE---------');
                    // console.log(year+'-' + month + '-'+dt);
                    
                    assumed_upcoming_delivery_dates.push(year+'-' + month + '-'+dt);
                }
...
// TayyabA
// alert(assumed_upcoming_delivery_dates);
console.log(assumed_upcoming_delivery_dates);

 var main_active_row_is=(parseInt($("#num_of_rows").val())) - (parseInt(active_delivery_counter_for_schedule));
     main_active_row_is = parseInt(main_active_row_is)+parseInt(1);
    //  alert('main_active_row_is: '+main_active_row_is);


   $("html, body").animate({ scrollTop: $("#bag_row_block_"+main_active_row_is).offset().top}, 1000);
   
   for(var y=0; y<active_delivery_counter_for_schedule; y++){
       
    //   alert('indiviual date is'+assumed_upcoming_delivery_dates[y]);
       $('#bag_row_block_'+main_active_row_is+'>div>input[name="date[]"]').val(assumed_upcoming_delivery_dates[y]);
       
        $('#bag_row_block_'+main_active_row_is).css('background-color', '#4fc6e1ad');
        
        
        var day="";
                     switch (new Date(assumed_upcoming_delivery_dates[y]).getDay()) {
                       case 0:
                         day = "Sun";
                         break;
                       case 1:
...
//   alert(day);
  ...
  $('#bag_row_block_'+main_active_row_is+'>div>input[name="day[]"]').val(day);
...
//   if(emirate!='---Select---' && service!='' && service!='---Select---'){
        ...
        var scroll='';
         var weekday = new Array(7);
            ...
            <?php if($this->uri->segment(5)=='edit_delivery_date') { ?>
                ...
                // alert('ADD NEW BAG ROW START : i am num of bag_row_counter:'+bag_row_counter);
                //  $('#bag_row_block_'+old_bag_rows_counter+'>div>select[name="S_D[]"]').attr("disabled", false);
                bag_row_counter +=1;
                // alert('ADD NEW BAG ROW AFTER ADD 1 : i am num of bag_row_counter:'+bag_row_counter);
    ...
    if(skip && check){
        ...
        //   $("#no_of_days").val(bag_row_counters);
           ...
           <?php if($this->uri->segment(5)=='edit_delivery_date') { ?>
          var temp_dys_correction=parseInt(bag_row_counters)-parseInt(new_freezed_row_cntr);
        //   alert('ORDANRY BAG ROW :the bag rows are :'+bag_row_counters+' the freeze row counter are:'+new_freezed_row_cntr)
          
          if(parseInt(new_freezed_row_cntr) ==0){
          var temp_dys= parseInt(num_day_record);
          }else{
              var temp_dys= parseInt(previous_day_rec);
          }
          temp_dys=temp_dys+parseInt(day_added_counter);
          
          $("#no_of_days").val(parseInt(temp_dys));
        //   $("#no_of_days").val(parseInt(temp_dys_correction));
...
//   document.documentElement.scrollTop = 0;
   ...
   var last_row_date_get=$("#bag_row_block_"+bag_row_counters+">div>input[name='date[]']").val();   
                                    // alert('last_row_date_get in ORDINARY ROW ADD FUNC: '+last_row_date_get);
                                
                                    
                                 XP_secure= moment(last_row_date_get).add(1,'days').format('YYYY-MM-DD');  
                                 
                                 old_bag_rows_counter_copy=bag_row_counters;
}    //function ends



function remove_bag_row() {
        // alert('i am REMOVE BAG ROW and here bag row counter is'+bag_row_counters);
        <?php if($this->uri->segment(5)=='edit_delivery_date') { ?>
        ...
        // For remove line heading of new delivery start
         ...
         //  End
           ...
           old_bag_rows_counter_copy -=1;
       
        
        //   alert('after remove 1 row bag counter is :'+ bag_row_counters);
          ...
          $("#tot_orders").val(bag_row_counters);
                            ...
                            //  var last_row_date_get=$("#bag_row_block_"+bag_row_counters+">div>input[name='date[]']").val();   
                            //         alert('last_row_date_get in ORDINARY ROW REMOVE FUNC: '+last_row_date_get);
        ...
        //  }
    //   alert('i am REMOVE BAG ROW AT ENDDDDDDDDDD bag row counter is'+bag_row_counters);  
    }
 ...
 function get_vendor_by_id(id,planid){
    ...
    $.post(url, $fields, function(response){
        if(response.success) {
            ...
            // alert('plan_data'+response.plan_data[0]);
            // alert('bag_qoute'+response.bags_qout.length);
            if(response.bags_qout.length ==0){
                // alert('NO DATA FOUND!');
                Swal.fire({position:"center",
                    type:"error",
                    title:"NO DATA FOUND!",
                    showConfirmButton:!1,
                    timer:49000}).then((result)=>{
                        window.close();
                    });
        ...
        //       }
            ...
            // RECENT FIND ISSUE
           $("#num_of_rows").val(response.bags_qout.length);
            $("#no_of_days").val(stats.no_days);
           num_day_record=stats.no_days;
           ...
           $("#vendor_id").val(vendor.vendor_id);
            ...
            bag_row_counters=parseInt(response.bags_qout.length);
            old_bag_rows_counter=parseInt(response.bags_qout.length);
            old_bag_rows_counter_copy=parseInt(response.bags_qout.length);
        ...
        //BAGS QOUTS
             var i=1;
             var upcoming_delivery_dates = [];   //welcome
             to_count_total_num_rows=response.bags_qout.length;
       ...
       <?php } ?>
                ...
                //  alert('hi i am runing o_d <= tody_dt');
      
                //  if(childArray.status =='Ship'){ 
                    //  innu && childArray.status !='Delivered'
                      if( o_d == tody_dt && childArray.status !='Delivered' && childArray.status !='Collected' && childArray.status !='Ship' && childArray.cancel != 'yes'){ 
                         //   alert(childArray.o_date);
                       upcoming_delivery_dates.push(childArray.o_date);
                       active_delivery_counter_for_schedule= (parseInt(active_delivery_counter_for_schedule))+(parseInt(1));
                    //   alert('i added in o_d == tody_dt'+active_delivery_counter_for_schedule)
                       } 
                    //   console.log('helo ayesha');
                        ...
                        //  console.log('i am if and addr obj'+addr_obj);
                         ...
                         // innaya g
                      var andthe_dt=childArray.fordaydate.toString();
                      console.log(andthe_dt);
                      
                        // var dt__x = moment(andthe_dt,"YYYY-MM-DD HH:mm:ss 12:00").utc().format("ddd");
                        // var dt__x = moment(andthe_dt + " 12:00", "DD-MM-YYYY HH:mm:ss").utc().format("dddd");
                        const dt__x = moment(new Date(andthe_dt+" UTC")).utc().format("ddd");
                         console.log(dt__x);
                        var fin_day=dt__x;
                        
                      var bag_row = '<div class="jumbotron row" id="bag_row_block_'+i+'"><div class=" col-sm-2"> <label for="date">Date</label><input title="Unable to change, kindly check date or delivery status." type="text" class="form-control" name="date[]" id="date" value="'+childArray.o_date+'" readonly></div><div class="col-sm-1"> <label for="day">Day</label><input type="text" class="form-control" name="day[]" id="day" value="'+fin_day+'" readonly></div> <div class="col-sm-4"> <label for="emirate">Select Address*</label><select  name="addr_list[]" id="addr_list" class="search_option form-control abc" onchange="myFunction_addr('+i+')" required">';
                    ...
                    //   $('#bag_row_block_'+i+'>div>select[name="S_D[]"]').attr("disabled", true);
                      ...
                      console.log('i am inside block case');
                        ...
                        //   alert('hi i am walking ');
                           active_delivery_counter_for_schedule= (parseInt(active_delivery_counter_for_schedule)) + (parseInt(1));
                        //   alert('i added in again : '+active_delivery_counter_for_schedule)  
                    ...
                    //   var bag_row = '<div class="jumbotron row" id="bag_row_block_'+i+'"><div class=" col-sm-2"> <label for="date">Date</label><div class="input-group input-large date-picker input-daterange" data-date="<?= date('Y-m-d', strtotime($cdate. ' + 1 days')); ?>" ><input type="text" class="form-control flatpickr-input active" name="date[]" id="date" value="'+childArray.o_date+'" ></div></div><div class="col-sm-1"> <label for="day">Day</label><input type="text" class="form-control" name="day[]" id="day" value="'+childArray.o_day+'" readonly></div> <div class="col-sm-4"> <label for="emirate">Select Address*</label> &nbsp  <span onclick="copy_to_next('+i+')" class="btn btn-xs">copy +1</span><select  name="addr_list[]" id="addr_list" class="search_option form-control abc" onchange="myFunction_addr('+i+')" required">';
                    ...
                    // innaya g
                     ...
                     var bag_row = '<div class="jumbotron row" id="bag_row_block_'+i+'"><div class=" col-sm-2"> <label for="date">Date</label><input title="Select to update delivery date. Upcoming blocked dates are reserved for other deliveries." type="text" onchange="update_dis_date('+i+')" class="form-control date_test " name="date[]" id="date" value="'+childArray.o_date+'" ></div><div class="col-sm-1"> <label for="day">Day</label><input type="text" class="form-control" name="day[]" id="day" value="'+fin_day+'" readonly></div> <div class="col-sm-4"> <label for="emirate">Select Address*</label> <select  name="addr_list[]" id="addr_list" class="search_option form-control abc" onchange="myFunction_addr('+i+')" required">';
                    ...
                    //   var bag_row = '<div class="jumbotron row" id="bag_row_block_'+i+'"><div class=" col-sm-2"> <label for="date">Date</label><input type="text" class="form-control" name="date[]" id="date" value="'+childArray.o_date+'" ></div><div class="col-sm-1"> <label for="day">Day</label><input type="text" class="form-control" name="day[]" id="day" value="'+childArray.o_day+'" readonly></div> <div class="col-sm-4"> <label for="emirate">Select Address*</label> &nbsp  <span onclick="copy_to_next('+i+')" class="btn btn-xs">copy +1</span><select  name="addr_list[]" id="addr_list" class="search_option form-control abc" onchange="myFunction_addr('+i+')" required">';
        ...
        //       $("#remove_bag_row_btn_"+i).attr("onclick","delete_rows_('"+i+"','b', '"+childArray.id+"')");
          ...
          $('#bag_row_block_'+last_row_val+'>div>select[name="S_D[]"]').attr("disabled", true);
            ...
            //     });
                        ...
                        //   alert('curr date: '+i_am_curr_dt+' date old p :'+date_old_p);
                          
                        //   TayyabA
                         $(".flatpickr-input").flatpickr({
                                        minDate: moment(i_am_curr_dt).format('YYYY-MM-DD')
                                    });
                        ...
                        //      XP_secure=moment(date_old_p).add(1,'days').format('YYYY-MM-DD');
                        ...
                        //             XP_secure=moment(i_am_curr_dt).add(1,'days').format('YYYY-MM-DD');
                        //  }else{
        ...
        // var arr_dates=[];
        // for( i=0 ; i<upcoming_delivery_dates.length;i++)
        //   {
        //       console.log(upcoming_delivery_dates[i]);
        //       arr_dates.push(new Date(upcoming_delivery_dates[i]));
        //   }
        ...
        //   $('.date_test').datepicker('setDates', arr_dates);
       var day = new Date();
       var nextM = new Date(day);
        nextM.setMonth(day.getMonth() + 3);
        console.log(nextM);
       ...
       $(".date_test").flatpickr({
      disable: upcoming_delivery_dates,
      dateFormat: "Y-m-d",
       minDate: tody_dt,
        maxDate:nextM,
      });
        
        this_date_is=tody_dt;
...
function update_dis_date(indx){
//   alert($(this).val());
//   alert('hi im runing');
//   var till=$("#no_of_days").val();
  var till=to_count_total_num_rows;
  var updated_dates_are=[];
  var old_track_is=[];
  for(var x=1; x<=till; x++){
       var dt_is=$('#bag_row_block_'+x+'>div>input[name="date[]"]').val();
       old_track_is[x]=dt_is;
       updated_dates_are.push(dt_is);
     //$('#bag_row_block_'+x+'>div>input[name="date[]"]').val(dt_is);
  }
  var select_dt_is=$('#bag_row_block_'+indx+'>div>input[name="date[]"]').val();
  //   var d = new Date(select_dt_is);
 // var n = d.getDay();
var day="";
switch (new Date(select_dt_is).getDay()) {
  case 0:
    day = "Sun";
    break;
  case 1:
...
//   alert(day);
  ...
  $('#bag_row_block_'+indx+'>div>input[name="day[]"]').val(day);
   
   $("#bag_row_block_"+indx).css('background-color', 'rgb(000 0FF 000)');
  
//   alert( updated_dates_are);
   var day = new Date();
  var nextM = new Date(day);
        nextM.setMonth(day.getMonth() + 3);
        console.log(nextM);
   $(".date_test").flatpickr({
      disable: updated_dates_are,
      dateFormat: "Y-m-d",
       minDate: this_date_is,
        maxDate:nextM,
      });
      
      
      for(var x=1; x<=till; x++){
       $('#bag_row_block_'+x+'>div>input[name="date[]"]').val(old_track_is[x]);
     }
...
function freeze_check(id){
    ...
    console.log('YESS I AM WORKING inside freeze check');
     ...
     if(freeze == 'Freezed'){
        ...
        Swal.fire({
                         title: 'Are you sure?',
                         html: 'This will hold the selected delivery and generate a new delivery in the end of meal plan',
                         type: 'warning',
                         showCancelButton: true,
                         confirmButtonColor: '#005266',
                         cancelButtonColor: '#B22E06',
                         ...
                         if (result.value) {
                          ...
                          }else{ // confirm buton end
                          
                          
                             $('#bag_row_block_'+id+'>div>select[name="freeze[]"]').val('Active');                
                                                    //  alert($('#bag_row_block_'+id+'>div>select[name="freeze[]"]').val());
                          }
        ...
        console.log('pk chcek'+pk_check);
           ...
           if(pk_check == 'S'){
            ...
            //   alert('freezed was the old status');
            //           alert('id is :'+id+' old row counter is:'+old_bag_rows_counter);
              var last_row_bagh_id=$("#bag_row_block_"+old_bag_rows_counter+">input[name='bagsHid[]']").val();         
                     
         if(id < old_bag_rows_counter &&  bag_row_counters == old_bag_rows_counter && (last_row_bagh_id!=0 || last_row_bagh_id!='') ){
               
              console.log('its mean no new rows are added other than already exist in db');
            //   alert('Last row have id , so directly will removed from db');
    ...
    // *******************************************************************
        ...
        Swal.fire({
                         title: 'Are you sure?',
                         html: 'This will have impact on delivery, will directly delete last delivery.',
                         type: 'warning',
                         showCancelButton: true,
                         confirmButtonColor: '#005266',
                         cancelButtonColor: '#B22E06',
                         ...
                         if (result.value) {
                            ...
                            //  alert('row id is:'+row_id+'  Main id is:'+mainid+'and plan id is:'+planID_secure);
                            ...
                            //      console.log(e_x_d);
                                        ...
                                        dataTye: 'json',
                                        data:{'del_id':row_id,
                                              'planid':planID_secure,
                                            //   'no_of_days':no_d,
                                            //   'exp_dt':e_x_d,
                                              'change_id':mainid
                                        },
                                      url: "<?php echo base_url('MonthlyMeal/delete_frozen_order') ?>",
                                      success: function (data){
                                          
                            Swal.fire({title:"Data has been Updated.",
                            text:"",
                            type:"success",
                            confirmButtonClass:"btn btn-confirm mt-2"});
                            ...
                            //   $('#bag_row_block_'+bag_row_counters+'>div>select[name="S_D[]"]').attr("disabled", true);
                                    ...
                                    //   var pr_id = new Date(pr_id);
                                                    ...
                                                    //     $("#Expiry_date").val(pr_id);
                                                     ...
                                                     $('#bag_row_block_'+id+'>div>select[name="freeze[]"]').val('Freezed');                
                                                    //  alert($('#bag_row_block_'+id+'>div>select[name="freeze[]"]').val());                
    ...
    // *********************************************************************
                  ...
                  }else if(id < old_bag_rows_counter &&  bag_row_counters == old_bag_rows_counter && (last_row_bagh_id==0 || last_row_bagh_id=='')){
                      
                      console.log('its mean new rows are added other than already exist in db');
                    //   alert('last row dont have bagh id just need to remove');
                      
                    //   alert(' BEFORE :: old_bag_rows_counter:'+old_bag_rows_counter+'  bag_row_counters:'+ bag_row_counters+ ' old_bag_rows_counter_copy:'+ old_bag_rows_counter_copy);
                                     $('#bag_row_block_'+id).css('background-color', '#36404a');
                                      console.log($('#bag_row_block_'+id+'>div>select[name="freeze[]"]').val());
                                       ...
                                       var last_row_date_get=$("#bag_row_block_"+old_bag_rows_counter+">div>input[name='date[]']").val();   
                                    // alert('last_row_date_get: '+last_row_date_get);
                                
                                     $(".flatpickr-input").flatpickr({
                                         minDate:last_row_date_get
                                      });
                                 XP_secure= last_row_date_get;  
                                          ...
                                          $('h3:last').remove();
                                        //   $('#bag_row_block_'+bag_row_counters).remove();
                                          old_bag_rows_counter_copy
                                          $('#bag_row_block_'+ old_bag_rows_counter_copy).remove();
                                          
                                          
                                        bag_row_counters -=1;
                                      old_bag_rows_counter -=1;
                                      old_bag_rows_counter_copy -=1;
                                      new_freezed_row_cntr -=1;
                            //   No effect on number of days because these are temprarory deliveries not db saved delivs
                    //  alert(' After :: old_bag_rows_counter:'+old_bag_rows_counter+'  bag_row_counters:'+ bag_row_counters+'  old_bag_rows_counter_copy:'+ old_bag_rows_counter_copy);                  
                    ...
                    //                                     $("#Expiry_date").val(pr_id);
                                              ...
                                              }else if(id == old_bag_rows_counter){
                                                //   alert('last row is eqaul to selected so nothing can happen');
                                              }else if(id < old_bag_rows_counter && (last_row_bagh_id==0 || last_row_bagh_id=='') ){
                                                  
                                                  var freeze_or_Active_row_check=$("#bag_row_block_"+old_bag_rows_counter+">input[name='freezed_track[]']").val();
                                                //   alert('unkown case!'+'id is:'+id+'old_bag_rows_counter:'+old_bag_rows_counter+' bagh_id:'+last_row_bagh_id+' freeze_or_Active_row_check:'+freeze_or_Active_row_check);
                                                  if( freeze_or_Active_row_check !='' || freeze_or_Active_row_check!=0){
                                                    //   alert('last row was freezed one so no need to update number of days here');
                                 ...
                                 XP_secure= last_row_date_get;  
                                      ...
                                      new_freezed_row_cntr -=1;
                                                    ...
                                                    //   alert('last row was new added row , need to update number of days just minus one day');
                                                     var day_calculations_are=parseInt($('#no_of_days').val())-parseInt(1);
                                                     
                                                      $('#no_of_days').val(day_calculations_are);
                                                      previous_day_rec=$('#no_of_days').val();
    ...
    //  var f_day= $('#bag_row_block_'+id+'>div>input[name="day[]"]').val();
     ...
     var f_status= $('#bag_row_block_'+id+'>div>select[name="freeze[]"]').val(); 
      ...
      var dt = new Date(f_date);
                    ...
                    //   because freeze row did not have impect on number of days, days should be same as freeze is a day replacement just
                    //   $("#no_of_days").val(bag_row_counters);
...
// alert('hi');
   ...
   // console.log(inp2);
          ...
          $.ajax({
            type: 'post',
            enctype: 'multipart/form-data',
            url: "<?php echo base_url('monthlyMeal/edit_order_deliverydateplan') ?>",
            data:formData,
            processData: false,
            contentType: false,
        ...
        swal('No Changes Found !', 'No changes were made', 'warning');
        console.log('Error :'+valid_check);
    }
    ...
    // $("#freeze_click").on('click', function () {
    
function freeze_click(id){
    
    //  alert('step1 num of rows:'+$("#num_of_rows").val());
    //   alert('Step 2 in freez bag_row_counter'+bag_row_counters);
var bag_id_of_freezed=$("#bag_row_block_"+id+">input[name='bagsHid[]']").val();
    //   alert('bag_id_of_freezed'+bag_id_of_freezed);
    //   exit;
       var entered_plan_days=parseInt(1) - parseInt(1);
  
    //
    
    // alert('Entered plan days are'+entered_plan_days);
    
    // alert('XP is:'+XP_secure);
   ...
   var fro=new Date(XP_secure);
      
   var fix_from=XP_secure;
...
var final_date_Calculated= yyyy + "-" + (mm[1]?mm:"0"+mm[0]) + "-" + (dd[1]?dd:"0"+dd[0]); // padding
    ...
    //   alert('final_date_Calculated to :'+to);
...
//   do{  
    ...
    for(var str=0; str<=assumed_days; str++ ){ 
                    ...
                    // alert('sm_dt'+sm_dt);
 dayx = weekdayx[st_dt_gen.getDay()];
//  alert('check dayx of generated date is '+dayx);
//  alert(dayx);
 ...
 if($("#module").val().includes(dayx)){
                    ...
                    //   alert('included day is : '+$("#module").val().includes(dayx));
                    //   alert('XXXX day to skip is:'+dayx+' ite'+str);
                       ...
                       var ddd  = (sm_dt.getDate()).toString();
                        ...
                        to=final_date_Calculated;
                       $("#to_date").val(final_date_Calculated);
                    //   alert('new updated end date is'+final_date_Calculated);
                       XP_secure=final_date_Calculated;
                        // var checkx=1
                   }else{
                    //   alert('XXXX no day for skip is found'+' ite'+str);
                       
                    //   var checkx=0;
                   }

//   }while(checkx==0); 
//   alert('update from - to is :'+fix_from+' - '+to);
  
  
  XP_secure=moment(to).add(1,'days').format('YYYY-MM-DD');
}
    // TESSTTT
...
add_new_row_whn_freeze(0,diffDays,daylist,skip,bag_id_of_freezed);


// alert('i am num of rows:');
// alert('i am number of rows:'+$("#num_of_rows").val());
old_bag_rows_counter=0;
old_bag_rows_counter=parseInt($("#num_of_rows").val());
// alert('new XP_secure:'+XP_secure);
    }        
    // });
    
    

function add_new_row_whn_freeze(id,total_gen,daylist,skip,bag_id_of_freezed){
        ...
        var scroll='';
         var weekday = new Array(7);
            ...
            <?php if($this->uri->segment(5)=='edit_delivery_date') { ?>
                ...
                // var  bag_row_counter=old_bag_rows_counter;
                 var  bag_row_counter=old_bag_rows_counter_copy;
                //Open last single double of exiting orders UMX
                
                //  $('#bag_row_block_'+old_bag_rows_counter+'>div>select[name="S_D[]"]').attr("disabled", false);
                // alert('In ADDING FREEZE ROW bag_row_counter'+bag_row_counter);
                bag_row_counter +=1;
                // alert('In ADDING FREEZE ROW bag_row_counter after add 1'+bag_row_counter);
                scroll=bag_row_counter;
                
                var line_='<h3 id="'+bag_row_counter+'" class="div1c">New Delivery generated instead of freezed delivery</h3>';
        ...
        day_i +=1;
                ...
                var bag_row = line_+'<div class="jumbotron row" id="bag_row_block_'+bag_row_counter+'"><div class=" col-sm-2"> <label for="date">Date</label><input type="text" class="form-control" name="date[]" id="date" value="'+year+'-' + month + '-'+dt+'" readonly></div><div class="col-sm-1"> <label for="day">Day</label><input type="text" class="form-control" name="day[]" id="day" value="'+day+'" readonly></div> <div class="col-sm-4"> <label for="emirate">Select Address*</label> <select  name="addr_list[]" id="addr_list" class="search_option form-control abc" onchange="myFunction_addr('+bag_row_counter+')" required">';
                            ...
                            if(addr_obj != undefined || addr_obj.length != 0) { 
                                ...
                                bag_row +=' </select> </div><div class="col-sm-2"> <label for="emirate">Emirate & Area</label><select  name="area[]" id="area" class="form-control abc" required><?php if (count($area) > 0) { ?> <?php foreach ($area as $data) { ?> <option class="" value="<?php echo $data->area_id; ?>"> <?php echo $data->area_name; ?> </option><?php }} ?></select> </div><div class="col-sm-2"> <label for="time">Time Slot*</label> <select  name="time[]" id="time" class="form-control abc" required><?php if (count($time) > 0) { ?> <?php foreach ($time as $key => $data) { ?> <option class="" value="<?php echo $key; ?>"> <?php echo $data; ?> </option><?php }} ?></select> </div>  <div class="adjust_t col-sm-3"> <label for="S_D">Google Link*</label> <textarea name="google_address[]" id="google_address" class="form-control rows=" 6" cols="30" readonly></textarea></div>  <div class="adjust_t col-sm-2"><label for="PickupPoint">Pickup Point</label> <input  class="form-control" type="text" name="PickupPoint[]" id="PickupPoint"  value="Office Location" /> </div>    <div class="adjust_t col-sm-2"><label for="Product Type">Product Type</label> <input  class="form-control" type="text" name="ProductType[]" id="ProductType" value="Food/Liquid"/> </div>  <div class="adjust_t col-sm-2"><label for="Delivery Amount">Delivery Amount</label> <input class="form-control" name="Delivery_Amount[]" id="Delivery_Amount" placeholder="(AED)" oninput="javascript:validity.valid||(value='+"' '"+');if(this.value.length < 0) this.value = this.value.slice(0, -0) ; if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength) ;" type="number" maxlength="8" step="0.01" min="0"> </div>  <div class="adjust_t col-sm-2"><label for="CompanyID">CompanyID/UniqueID</label> <input  class="form-control" type="text" name="CompanyID[]" id="CompanyID"/> </div> <div class="adjust_t col-sm-3"><label for="notes">Notes</label> <textarea name="notes[]"  class="form-control rows=" 6" cols="30"></textarea></div> <div class="adjust_t col-sm-2"><label for="notification">Notification</label> <select class="form-control" name="notification[]" required=""><option value="Yes">Yes</option><option value="No">No</option></select></div>  <input type="hidden" name="bagsHid[]" value="" class="form-control" /> <input type="hidden" name="delivered_check[]" value="" id="delivered_check"/>   <input type="hidden" name="freezed_track[]" value="'+bag_id_of_freezed+'" id="freezed_track"/> </div><hr>';
          ...
          $("#num_of_rows").val(bag_row_counters);
        //   $("#no_of_days").val(bag_row_counters);
          new_freezed_row_cntr = new_freezed_row_cntr + parseInt(1);
          $scv=parseInt($("#no_of_days").val());
...
//   document.documentElement.scrollTop = 0;
    ...
    // alert('In ADDING FREEZE ROW AT END bag_row_counter'+bag_row_counters);  
      old_bag_rows_counter_copy=parseInt(bag_row_counters);
       ...
       previous_day_rec=parseInt($('#no_of_days').val());
}    //function ends
