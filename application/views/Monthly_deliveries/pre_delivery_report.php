                         ...
                         <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Vendors PreDelivery Report </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Vendor Wise PreDelivery Report </a></li>
                                  
                                </ol>
                            </div>
                          <h4 class="page-title">Vendor Wise PreDelivery Report</h4>
                        </div>
                    </div>
                </div>
                </div>
...
<div class="container-fluid">
 ...
 <form action="<?php echo base_url('Ptests/predelivery_report') ?>" id="add_vendor_form"  name ="form" method="post" class="horizontal-form" >
    <!-- BEGIN PAGE HEADER-->
      <div class="row">
                    ...
                    <div class="col-lg-5">
                        ...
                        <button onclick="get_reports(event)" class="btn blue"style="color: #fff;background-color: #197990 !important;border-color: white;margin-top: 10px;">Get PreDeliveries MealPlaner Report </button>
                        &nbsp &nbsp
                        <button type="submit" class="btn blue"style="color: #fff;background-color: #197990 !important;border-color: white;margin-top: 10px;">Download MealPlaner Report</button>
                        ...
                        &nbsp &nbsp <button type="submit" formaction="<?php echo base_url('ptests/predelivery_report_email'); ?>" class="btn blue"style="color: #fff;background-color: #197990 !important;border-color: white;margin-top: 10px;">Send MealPlaner Email</button>
                    ...
                    <div class="col-lg-5">
                       <div class="btn-group"> 
                        &nbsp &nbsp
                        <button onclick="get_reports_all(event)" class="btn blue"style="color: #fff;background-color: #197990 !important;border-color: white;margin-top: 10px;">Get PreDeliveries All Report </button>
                        &nbsp &nbsp
                        <button type="submit" formaction="<?php echo base_url('Ptests/predelivery_ALLreport'); ?>" class="btn blue"style="color: #fff;background-color: #197990 !important;border-color: white;margin-top: 10px;">Download PreDeliveries  All Report</button>
                        &nbsp &nbsp <button type="submit" formaction="<?php echo base_url('ptests/predelivery_report_email_all'); ?>" class="btn blue"style="color: #fff;background-color: #197990 !important;border-color: white;margin-top: 10px;">Send PreDeliveries All Email</button>
...
<script type="text/javascript">
    ...
    function get_reports_all(e){
        ...
        get_deliveries_report_by_vendor_all(vendor_id, e.target);
        }else{
            swal('missing fields', 'Please Select vendor!', 'error');
        }
    ...
    function get_deliveries_report_by_vendor(vendor_id, el){
        ...
        var url = "<?php echo base_url(); ?>"+"MonthlyMeal/get_pre_deliveries_report_by_vendor_plans";
        ...
        if(vendor_id) {
            ...
            $.post(url, $fields, function (response) {
                el.disabled = false;
                el.innerHTML = 'Get PreDeliveries Plan Report';
                var data = '';
                $("#table_body").empty();
    ...
    function get_deliveries_report_by_vendor_all(vendor_id, el){
        $("#download_btn_container").hide();
        var from_date = moment($("#from_date").val()).format('YYYY-MM-DD 00:00:00');
        var to_date = moment($("#to_date").val()).format('YYYY-MM-DD 23:59:59');
        ...
        var url = "<?php echo base_url(); ?>"+"MonthlyMeal/get_pre_deliveries_report_by_vendor_all";
        $fields = {'start_date':from_date, 'end_date':to_date, 'vendor_id':vendor_id};
        ...
        if(vendor_id) {
            ...
            $.post(url, $fields, function (response) {
                el.disabled = false;
                el.innerHTML = 'Get PreDeliveries All Report';
                var data = '';
                $("#table_body").empty();
    ...
    function set_report_data(data){
        ...
        $.each(data, function(i, e){
          ...
          tbody += '<tr class="odd gradeX">';
            ...
            tbody += '<td style="min-width: 5px;">'+ e.plan_id +'</td>';
            tbody += '<td style="min-width: 5px;">'+ e.pcustomer_id +'</td>';
            tbody +='<td style="min-width: 250px; align:center;">'+e.name_on_delivery+'<br>'+e.number_on_delivery+'</td>';
            tbody+='<td style="min-width: 150px;">'+e.delivery_date+'</td>';
            tbody +='<td style="min-width: 100px;">'+e.status+'</td>';
            tbody +='<td style="min-width: 250px; align:center;">'+e.delivery_address+'</td>';
            tbody +='<td style="min-width: 250px; align:center;">'+e.delivery_time+'</td>';
