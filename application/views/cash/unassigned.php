                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Operations </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Unassigned Cash Collection</a></li>
                                  
                                </ol>
                            </div>
                            <h4 class="page-title">UNASSIGNED CASH COLLECTION</h4>
                    ...
                    <div class="col-lg-12">
                        <div class="card-box" style="width: 101% !important;">
                           <!--  <h4 class="header-title">Vender list</h4> -->
                             <form action="<?php echo base_url('cash/unassigned_by_created_date') ?>" method="post">
                    <div class="row">
                 ...
                 <div class="row">
                    <div class="col-md-3">
                     ...
                     <div class="col-lg-4" style="display: none;" id="action_btn">
                        ...
                        <button type="button" id="Auto_button" style="color: #fff;background-color: #197990 !important;border-color: white;" class="btn btn-primary">Auto Assign</button>
                        ...
                        <button id="cancel_btn" type="button" class="btn btn-danger">Cancel</button>
                   </div>
                  </div>
              <?php }else { ?>
                <div class="row">
                ...
                <div class="modal-dialog" style="width: 500px">
                    <div class="modal-content" style="width: 120% !important;">
                        <div class="modal-header" style="background: linear-gradient(to right, #004C5D 0%, #00BAF1 100%);">
                            ...
                            <h4 class="modal-title" id="mod_title" style="color: white;">Add Cash Collection</h4>
                        </div>
                 ...
                 <div id="custom-modals" class="modal-demo" style="padding: 35px;">
                        <blockquote class="hero">
                            <p> Click <a href="<?php echo base_url(); ?>download/BagCSVFormat.csv">HERE</a> to Download final Cash Collection CSV File Format!</p>
                        </blockquote>
  ...
  if (result.value) {
    ...
    $(document).ready(function () {
        ...
        $("#print_btn").click(function(){
                ...
                if(ids.length < -1)
                    return;
                ids = ids.join();
                window.open('<?php echo base_url() ?>report/print/cashs/'+ids, '_blank');
        });
   ...
   if(global_cash_ids.length > 0){
    ...
    function cancel_cash(){
        if(global_cash_ids.length > 0){
            var url = "<?php echo base_url(); ?>"+"cash/cancel_cash";
            $fields = { 'cash_ids':global_cash_ids};
            $.post(url, $fields, function(response){
                if(response.success){
                    global_cash_ids = [];
            ...
            var msg = '<strong>Success!</strong> Data has been cancel.';
            show_msg(msg, 'alert-success');
    ...
    function assign_drivers(){
        ...
        if(global_cash_ids.length > 0 && driver_id){
            console.log("Called"+global_cash_ids+"DRIVER:"+driver_id);
            var url = "<?php echo base_url(); ?>"+"cash/assign_drivers";
            $fields = {'driver_id':driver_id, 'cash_ids':global_cash_ids};
            $.post(url, $fields, function(response){
    ...
    function auto_assign_deliv()
{
   ...
   if(global_cash_ids.length > 0){
       console.log("Called"+global_cash_ids);
         $.ajax({

            url:'<?php echo base_url("cash/Auto_assign_drivers") ?>',
            method:'post',
            data:{'bag_ids':global_cash_ids},
            success:function(res)
            {
                 console.log(res);
                if(res=='true'){
                    ...
                    swal("", "Some Cash Not Assigned Successfully!", "error");
