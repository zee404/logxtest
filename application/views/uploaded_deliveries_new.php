...
text/x-generic uploaded_deliveries_new.php ( HTML document, ASCII text, with very long lines )
<!DOCTYPE html>
<html lang="en">
                          ...
                          <div class="btn-group">
                            ...
                            <table id="order_table"  class="example  table  table-responsive  table-bordered " style="display:table;overflow-x: auto;">
                                ...
                                <tr>
                                    ...
                                    <th data-field="address" data-align="center" data-sortable="true" data-formatter="" style="min-width:50px">Delivery Address</th>
                                    ...
                                    <th data-field="v" data-align="center" data-sortable="true" data-formatter="">Uploaded By</th>
...
function build_table_and_data(e)
    {
       ...
       un_assign_table= $('#order_table').DataTable({
        ...
        "columns": [
            ...
            { "data": "delivery_address", "orderable": true},
