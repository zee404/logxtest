                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="<?php echo base_url('auth/userdashboard');?>">Dashboard </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Active Partners</a></li>
                                  
                                </ol>
                            </div>
                          <h4 class="page-title">Active Partners</h4>
                        </div>
                    </div>
                </div>
                </div>
            ...
            <td><?php echo $records[$key]->full_name.'<br/>'.$records[$key]->phone ?> </td>
             ...
             <td>
                 <table class="table table-bordered table-hover">
                       ...
                       <th class="highlights">Total Assigned</th>
                       <th class="highlights">Total Unassigned</th>
                 ...
                 echo '<tr><td class="slots_highlight"><a title="Click to view Time-Slot wise" target="_blank" href="'.$basic_urlx.'" >'.$records[$xtemp]->delivery_time.'</a></td><td><a title="Click to view Total Deliveries" target="_blank" href="'.$basic_urlx.'" >'.$records[$xtemp]->orders.'</a></td><td><a title="Click to view Delivered orders" target="_blank" href="'.$basic_urlx.'delivered'.'" >'.$records[$xtemp]->total_delivered.'</a></td><td><a title="Click to view Assigned Deliveries" target="_blank" href="'.$basic_urlx.'assigned'.'" >'.$records[$xtemp]->total_assign.'</a></td><td><a title="Click to view Unassigned Deliveries" target="_blank" href="'.$basic_urlx.'unassigned'.'" >'.$records[$xtemp]->total_not_assign.'</a></td><td><a title="Click to view Canceled Deliveries" target="_blank" href="'.$basic_urlx.'canceled'.'" >'.$records[$xtemp]->total_canceled.'</a></td><td><a title="Click to view Inshiped Deliveries" target="_blank" href="'.$basic_urlx.'inship'.'" >'.$records[$xtemp]->total_ship.'</a></td></tr>'; 
                   
                   $totDel=$totDel+$records[$xtemp]->orders; 
                    $totComp=$totComp+$records[$xtemp]->total_delivered; 
                    $totPen=$totPen+$records[$xtemp]->total_assign; 
                    $totNotas=$totPen+$records[$xtemp]->total_not_assign;
                ...
                //  echo ' <tr><td class="slots_highlight">'.$records[$xtemp]->delivery_time.'</td><td>'.$records[$xtemp]->orders.'</td><td>'.$records[$xtemp]->total_delivered.'</td><td>'.$records[$xtemp]->total_assign.'</td><td>'.$records[$xtemp]->total_not_assign.'</td><td>'.$records[$xtemp]->total_canceled.'</td><td>'.$records[$xtemp]->total_ship.'</td> ';
                 echo '<tr><td class="slots_highlight"><a title="Click to view Time-Slot wise" target="_blank" href="'.$basic_urlx.'" >'.$records[$xtemp]->delivery_time.'</a></td><td><a title="Click to view Total Deliveries" target="_blank" href="'.$basic_urlx.'" >'.$records[$xtemp]->orders.'</a></td><td><a title="Click to view Delivered orders" target="_blank" href="'.$basic_urlx.'delivered'.'" >'.$records[$xtemp]->total_delivered.'</a></td><td><a title="Click to view Assigned Deliveries" target="_blank" href="'.$basic_urlx.'assigned'.'" >'.$records[$xtemp]->total_assign.'</a></td><td><a title="Click to view Unassigned Deliveries" target="_blank" href="'.$basic_urlx.'unassigned'.'" >'.$records[$xtemp]->total_not_assign.'</a></td><td><a title="Click to view Canceled Deliveries" target="_blank" href="'.$basic_urlx.'canceled'.'" >'.$records[$xtemp]->total_canceled.'</a></td><td><a title="Click to view Inshiped Deliveries" target="_blank" href="'.$basic_urlx.'inship'.'" >'.$records[$xtemp]->total_ship.'</a></td></tr>'; 
                    ...
                    $totComp=$totComp+$records[$xtemp]->total_delivered; 
                    $totPen=$totPen+$records[$xtemp]->total_assign; 
                    $totNotas=$totNotas+$records[$xtemp]->total_not_assign;
                    $totCan=$totCan+$records[$xtemp]->total_canceled; 
                    $totIn=$totIn+$records[$xtemp]->total_ship;
                }
              ?>
              ...
              <tr>
                           ...
                           <td class="highlights"><?php echo $totNotas ; ?></td>
...
<script type="text/javascript">
   ...
   var base_url=<?php echo base_url ?> ;
    ...
    function get_reports(e){
        ...
        window.location.href = base_url+'auth/Active_Partners/'+from_date+'/'+to_date;
