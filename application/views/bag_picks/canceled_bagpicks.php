                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Operations </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Cancelled Pickup Bags</a></li>
                                  
                                </ol>
                            </div>
                           <h4 class="page-title">Cancelled Pickup Bags</h4>
                        </div>
                    </div>
                </div>     
                    ...
                    <div class="col-lg-2">
                          <div class="btn-group">
                            ...
                            <div class="card-box" style="width: 104% !important;">  
                                ...
                                <div class="col-lg-6">
                                    <button type="button" class="btn btn-danger" id="process_button">Revert Cancellation (Bag And Delivery)</button>
...
$('.search_option_t').select2({
  ...
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
  confirmButtonText: 'Yes, Revert Cancellation !'
}).then((result) => {
  if (result.value) {
    var idds = [];
...
{
         $('#process_button').html('<span class="spinner-border spinner-border-sm mr-1" role="status" aria-hidden="true"></span>Loading');
...
dom: 'Blifrtip',
    ...
    function get_deliveries_report_by_status(el){
        ...
        var url = "<?php echo base_url(); ?>"+"report/get_canceled_bagpicks";
