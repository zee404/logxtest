                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="javascript: void(0);">Operations </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Requested Cancel Pickup Bags</a></li>
                                  
                                </ol>
                            </div>
                           <h4 class="page-title">Requested Cancel Pickup Bags</h4>
                        </div>
                    </div>
                </div>     
                    ...
                    <div class="col-lg-2">
                          <div class="btn-group">
                            ...
                            <div class="card-box" style="width: 104% !important;">  
                                ...
                                <div class="col-lg-6">
                                    <button type="button" class="btn btn-danger" id="cancelled_button">Cancel Bag And Delivery</button>
                            ...
                            <table id="order_table"   class="example  table  table-responsive  table-bordered ">
                                ...
                                <th class="table-checkbox" ><input type="checkbox" class="checkAll" style="zoom: 2.5;"></th>
                                    ...
                                    <th data-field="status" data-align="left"  data-sortable="true" data-formatter="" style="min-width:100px">Bag Cancel Notes</th>
                                     
                                     <th data-field="status" data-align="left"  data-sortable="true" data-formatter="" style="min-width:150px">Image</th>
                                    ...
                                    <th data-field="v" data-align="date" data-sortable="true" data-formatter="" >Cancel Request At</th>
                                    <th data-field="v" data-align="left" data-sortable="true" data-formatter="">Bag Assigned At</th>
                                      ...
                                      <tr class="" id="<?php echo $order->order_id;?>">
                                        ...
                                        <td><?php echo $key+1;?></td>
                                         ...
                                         <?php if($order->bag_image !='' AND $order->driver_cancel_request ==1){
                                            echo '<td><a class="Green" alt="Cancel Bag Image" title="Click to View" target="_blank" href="'.base_url().'upload_canc_bagpick/'.$order->bag_image.'"><img src="'.base_url().'upload_canc_bagpick/'.$order->bag_image.'" width="100%" class="img-responsive img-thumbnail"></a></td>';
                                        }else{
                                            echo '<td>N/A</td>';
                                        }
                                        ?>
                                       ...
                                       <td ><?php echo $order->driver_request_at;?></td>   
...
dom: 'Blifrtip',
    ...
    function get_deliveries_report_by_status(el){
        ...
        var url = "<?php echo base_url(); ?>"+"report/get_req_canceled_bagpicks";
  ...
  function set_report_data(data){
        ...
        $.each(data, function(i, e){
           ...
           if(e.bag_image !='' && e.driver_cancel_request ==1){
                   tbody += '<td><a class="Green" alt="Cancel Bag Image" title="Click to View" target="_blank" href="<?php echo base_url() ?>upload_canc_bagpick/'+e.bag_image+'"><img src="<?php echo base_url(); ?>upload_canc_bagpick/'+e.bag_image+'" width="100%" class="img-responsive img-thumbnail"></a></td>';
                 }else{
                    tbody += '<td>N/A</td>';
                      }
            ...
            tbody += '<td >'+e.driver_request_at+'</td>';
...
function cancelAll(ids)
        {
            $('#cancelled_button').html('<span class="spinner-border spinner-border-sm mr-1" role="status" aria-hidden="true"></span>Loading');
            $('#cancelled_button').prop('disabled',true);
             $.ajax({
