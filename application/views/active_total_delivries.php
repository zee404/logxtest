                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                   <li class="breadcrumb-item"><a href="<?php echo base_url('auth/userdashboard');?>">Dashboard </a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Active Total Deliveries</a></li>
                                  
                                </ol>
                            </div>
                          <h4 class="page-title">Active Total Deliveries</h4>
                        </div>
                    </div>
                </div>     
                        ...
                        <?php }else{ ?>
                            ...
                            <table  class="example1 table table-responsive"  id="order_table">
                                ...
                                <?php if ($orders['result']){
                                    ...
                                    <td> <button class='btn <?php echo ($order->payment_status ==0) ? 'whn_zero' :'bold_with_grn' ?>' onclick='javascript:change_payment_status(this)' value='<?php echo $order->payment_status ?>' data-orderid='<?php echo  $order->order_id ?>'><?php echo ($order->payment_status ==0) ? 'Unpaid' :'Paid' ?> </button> </td>
