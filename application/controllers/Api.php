...
*/
    ...
    public function valid_string_fn($str)
    {
        ...
        $res_str = str_replace(array('\'', '"', 'ʹ', '.', ' ‬-', ';', '<', '>', '‏',), '', $res_str);
        $res_str = str_replace("'", "", $res_str);
        $res_str = str_replace("ʹ", "", $res_str);
        $res_str = str_replace(" ‏", "", $res_str);
        $res_str = str_replace("‏", "", $res_str);
        $res_str = str_replace("’", "", $res_str);
