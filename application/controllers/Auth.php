...
class Auth extends CI_Controller
{
    ...
    public function userdashboard($f_date = null, $t_date = null)
    {
        ...
        if ($this->session->userdata('role') != 'vendor') {
            ...
            $data['deliveries_by_slots'] = $this->DM->get_deliveries_by_slots($f_date, $t_date);


            // echo '<pre>';
            // print_r($data['deliveries_by_slots']);
            // die();
        }
        ...
        if ($this->session->userdata('role') == 'vendor') {
            ...
            //   }
            //   echo '<pre>';
            //   print_r($data['deliveries_by_slots2']);
            // die();
        }
    ...
    public function Active_total_deliveries()
    {
        ...
        if ($this->session->userdata('role') != 'vendor') {
            ...
            if ($this->uri->segment(6)) {
                $where .= 'AND o.slotID =' . $this->uri->segment(6);
            }
        } else {
        ...
        o.customer_id, o.driver_id, o.vendor_id, o.`status`, o.delivery_address,o.assigned_user,o.assigned_mode,o.canceled_at,o.canceled_by,o.canceled_reason,o.canceled_mode,o.canceled_img,o.partner_price,o.discount_track,
         DATE_FORMAT(o.delivery_date,"%d-%m-%Y") as delivery_date, o.delivery_time, o.created,o.created_user,o.assign_date,o.payment_status,
        ...
        c.full_name as customer,c.user_notes as special_instructions, d.full_name as driver, v.full_name as vendor, c.address,
